...
{
 "slug": "di-kham-thai-mot-lan-het-bao-nhieu",
 "cum": "A",
 "ngay_dang": "2026-09-23",
 "tag": "Thai sản",
 "doc": "6 phút đọc",
 "title": "Đi khám thai một lần hết bao nhiêu: ba bệnh viện công bố tiền công khám, từ 120.000đ tới 500.000đ",
 "h1": "Một lần khám thai tốn bao nhiêu tiền công",
 "desc": "Ba bệnh viện đăng tiền công khám thai bằng một con số, thấp nhất 120.000 đồng, cao nhất 500.000 đồng. Một nơi thu tạm ứng thay vì thu theo lần, một nơi chỉ bán gói theo tuần.",
 "tom_tat": "Trong 21 bệnh viện chúng tôi đang theo, chỉ <b>năm nơi</b> có bảng khám thai và siêu âm. Của năm nơi đó, ba nơi ghi tiền công một lần khám bằng con số cụ thể: Xuyên Á cơ sở Củ Chi <b>120.000 đồng</b>, Đại học Y Dược cơ sở 2 <b>150.000 đồng</b>, Phụ sản Hà Nội <b>300.000 đồng</b> khu tự nguyện và <b>500.000 đồng</b> khu chuyên gia. Hùng Vương không bán lẻ từng lần mà thu tạm ứng vào thẻ khám. Hạnh Phúc chỉ bán gói theo tuần đăng ký, rẻ nhất 9.900.000 đồng.",
 "bang": [
   {
     "ten": "Tám dòng tiền công khám thai ở ba bệnh viện công bố bằng số",
     "kiem_chung": "chinh-thuc",
     "nguon": "Bệnh viện Đa khoa Xuyên Á, Bảng giá dịch vụ kỹ thuật 2025 đăng trên bvxuyena.com.vn, phần cơ sở Củ Chi. Bệnh viện Đại học Y Dược TP.HCM, bảng giá dịch vụ khám bệnh chữa bệnh cơ sở 2 trên bvdaihoccoso2.com.vn, bản cập nhật 15/01/2026. Bệnh viện Phụ sản Hà Nội, bảng giá dịch vụ khám sản và phụ khoa cơ bản trên benhvienphusanhanoi.vn, đăng 22/05/2026.",
     "cot": ["Bệnh viện", "Loại khám", "Giá bệnh viện ghi"],
     "hang": [
       ["Xuyên Á &mdash; Củ Chi", "Khám Phụ sản", "<b>120.000đ</b>"],
       ["Xuyên Á &mdash; Củ Chi", "Khám Phụ sản ngoài giờ", "150.000đ"],
       ["Xuyên Á &mdash; Củ Chi", "Khám cấp cứu", "150.000đ"],
       ["Đại học Y Dược &mdash; cơ sở 2", "Khám thai", "150.000đ"],
       ["Đại học Y Dược &mdash; cơ sở 2", "Khám thai (cấp cứu)", "360.000đ"],
       ["Đại học Y Dược &mdash; cơ sở 2", "Tư vấn chu sinh", "150.000đ"],
       ["Phụ sản Hà Nội", "Khám thai khu tự nguyện", "300.000đ"],
       ["Phụ sản Hà Nội", "Khám thai khu chuyên gia (Giám đốc, PGS, bác sĩ cao cấp)", "<b>500.000đ</b>"],
     ],
   },
   {
     "ten": "Hùng Vương ghi tiền tạm ứng thay cho giá từng buổi khám",
     "kiem_chung": "chinh-thuc",
     "nguon": "Bệnh viện Hùng Vương, mục Hỏi &ndash; Đáp trên bvhungvuong.vn, trả lời đăng ngày 09/07/2023.",
     "cot": ["Loại khám", "Tạm ứng", "Bệnh viện ghi thêm"],
     "hang": [
   ...
   {
     "ten": "Bốn gói khám thai theo tuần đăng ký của Bệnh viện Quốc tế Hạnh Phúc",
     "kiem_chung": "chinh-thuc",
     "nguon": "Bệnh viện Quốc tế Hạnh Phúc, trang gói khám thai goikhamthai.hanhphuchospital.com, bản cập nhật 05 &ndash; 07/01/2026.",
     ...
     "hang": [
       ...
       ["Khai Hoa", "tuần 36 &ndash; 40", "<b>9.900.000đ</b>"],
     ],
   },
 ],
 "y_chinh": [
   ["Cùng là một lần khám thai, ba bệnh viện ghi ba mức cách nhau 4,17 lần",
    "Dòng thấp nhất là Khám Phụ sản ở Xuyên Á cơ sở Củ Chi, 120.000 đồng. Dòng cao nhất là khám thai khu chuyên gia ở Phụ sản Hà Nội, 500.000 đồng. Chia ra được 4,17 lần. Nếu chỉ lấy dòng khám thường ở cả ba nơi thì khoảng cách hẹp hơn: 120.000 đồng, 150.000 đồng và 300.000 đồng, tức 2,5 lần. Phần chênh còn lại nằm ở chữ chuyên gia, và không bệnh viện nào mô tả chuyên gia thì buổi khám khác buổi khám thường chỗ nào."],
   ["Khám cấp cứu đắt thêm bao nhiêu thì mỗi nơi một kiểu",
    "Xuyên Á ghi khám cấp cứu 150.000 đồng, hơn khám thường 30.000 đồng. Đại học Y Dược ghi khám thai cấp cứu 360.000 đồng, hơn khám thai thường 210.000 đồng. Cùng một cụm chữ trên hai bảng giá, khoản chênh lệch nhau bảy lần. Ai đi khám ngoài giờ hành chính nên hỏi trước bệnh viện xếp buổi khám của mình vào dòng nào."],
   ["Hùng Vương không bán một lần khám, nên con số của họ không đặt cạnh ba nơi kia được",
    "Trả lời trên mục Hỏi &ndash; Đáp ngày 09/07/2023, Hùng Vương ghi khám thai dịch vụ tạm ứng 500.000 đến 1.600.000 đồng và khám thai chuyên gia tạm ứng 1.500.000 đến 3.000.000 đồng, cả hai đều trừ dần vào thẻ khám. Tạm ứng là tiền nạp trước cho nhiều lần, không phải giá một buổi. Đặt 500.000 đồng của Hùng Vương cạnh 120.000 đồng của Xuyên Á là so hai thứ khác loại. Trả lời này cũng đã hơn ba năm, chúng tôi chép lại đúng như bệnh viện đăng và không giả định nó còn nguyên."],
   ["Gói khám thai đăng ký muộn thì tổng tiền rẻ hơn, nhưng mỗi tuần được theo lại đắt hơn",
    "Hạnh Phúc bán bốn gói, mốc bắt đầu càng muộn thì giá càng thấp: tuần 10 giá 26.000.000 đồng, tuần 16 giá 18.500.000 đồng, tuần 24 giá 15.800.000 đồng, tuần 36 giá 9.900.000 đồng. Lấy hai đầu mà trừ theo mốc tuần bệnh viện ghi thì gói Tâm An theo 30 tuần còn gói Khai Hoa theo 4 tuần. Số tuần chênh 7,5 lần, tổng tiền chỉ chênh 2,63 lần. Phép trừ và phép chia này là của chúng tôi, bệnh viện chỉ đăng bốn mức giá và bốn mốc tuần."],
   ["Tư vấn chu sinh là một dòng riêng, không nằm trong tiền khám thai",
    "Bảng của Đại học Y Dược cơ sở 2 tách tư vấn chu sinh thành dòng riêng, 150.000 đồng, bằng đúng tiền khám thai. Nghĩa là một buổi vừa khám vừa được tư vấn chu sinh sẽ ra hai dòng trên phiếu thu chứ không phải một. Bốn bệnh viện còn lại không có dòng nào tên như vậy."],
   ["Ba câu nên hỏi trước khi đặt lịch khám thai",
    "Một, tiền công khám hôm đó tính theo dòng nào trong bảng giá, khám thường hay khám chuyên gia hay khám ngoài giờ. Hai, siêu âm và xét nghiệm tính riêng hay đã nằm trong tiền khám. Ba, nếu nộp tiền theo thẻ khám hoặc theo gói thì số tiền nộp trước đó trừ vào những khoản gì, và không dùng hết thì xử lý ra sao. Ba câu này quyết định phần lớn chênh lệch giữa con số trên bảng giá và con số trên phiếu thu."],
 ],
 "khong_ro": [
   "Mười sáu trong 21 bệnh viện chúng tôi đang theo không đăng bảng khám thai hay siêu âm nào, nên không có con số để đưa vào bài này.",
   "Hạnh Phúc không công bố mỗi gói khám thai gồm bao nhiêu lần khám, bao nhiêu lần siêu âm hay những xét nghiệm nào. Chúng tôi chỉ có giá và mốc tuần.",
   "Bảng của Xuyên Á ghi rõ là Bảng giá dịch vụ kỹ thuật 2025. Chúng tôi không biết bệnh viện đã có bản mới hơn hay chưa, nên không gọi đây là giá năm 2026.",
   "Không bệnh viện nào trong năm nơi này nói một thai kỳ cần bao nhiêu lần khám, nên bài này không nhân ra tổng tiền cả thai kỳ.",
 ],
 "faq": [
   ["Một lần khám thai rẻ nhất trong dữ liệu là bao nhiêu?",
    "120.000 đồng, dòng Khám Phụ sản trong Bảng giá dịch vụ kỹ thuật 2025 của Bệnh viện Đa khoa Xuyên Á cơ sở Củ Chi. Đó là tiền công khám, chưa gồm siêu âm và xét nghiệm."],
   ["Khám chuyên gia có khác gì khám thường không?",
    "Bảng giá không nói. Phụ sản Hà Nội chỉ ghi khu chuyên gia là Giám đốc, phó giáo sư, bác sĩ cao cấp, giá 500.000 đồng so với 300.000 đồng khu tự nguyện. Nội dung buổi khám khác nhau ra sao thì không có tài liệu nào mô tả."],
   ["Tiền khám thai đã gồm siêu âm chưa?",
    "Ở Đại học Y Dược cơ sở 2 và Xuyên Á thì chưa, vì siêu âm thai là dòng giá riêng trong cùng bảng. Ở Hạnh Phúc thì bệnh viện bán theo gói và không tách giá từng khoản."],
   ["Có bảo hiểm y tế thì trả bao nhiêu cho một lần khám thai?",
    "Hai trong năm bệnh viện đăng kèm cột bảo hiểm y tế: Đại học Y Dược ghi 50.600 đồng và Xuyên Á ghi 39.800 đồng cho một lần khám. Chúng tôi tách riêng phần này trong bài bảo hiểm y tế trả bao nhiêu cho một lần khám thai."],
 ],
 "lien_quan": ["bhyt-tra-bao-nhieu-cho-mot-lan-kham-thai", "gia-mot-lan-sieu-am-thai", "chi-phi-cho-em-be-sau-khi-sinh"],
},

{
 "slug": "bhyt-tra-bao-nhieu-cho-mot-lan-kham-thai",
 "cum": "D",
 "ngay_dang": "2026-09-23",
 "tag": "Bảo hiểm y tế",
 "doc": "7 phút đọc",
 "title": "Bảo hiểm y tế trả bao nhiêu cho một lần khám thai: 12 dòng giá có đủ hai cột ở hai bệnh viện",
 "h1": "Bảo hiểm y tế trả bao nhiêu cho một lần khám thai",
 "desc": "Hai bệnh viện đăng bảng khám thai có cả giá dịch vụ lẫn mức bảo hiểm y tế. Mười hai dòng đó cho thấy cột bảo hiểm đứng yên khi cột giá thay đổi, và một dòng ghi thẳng mức 0 đồng.",
 "tom_tat": "Trong năm bệnh viện có bảng khám thai và siêu âm, <b>hai nơi</b> đăng kèm cột bảo hiểm y tế: Đại học Y Dược cơ sở 2 (5 dòng) và Xuyên Á cơ sở Củ Chi (7 dòng). Mười hai dòng này cho thấy một điều: khi giá dịch vụ đổi thì mức bảo hiểm y tế vẫn đứng nguyên. Khám thai thường và khám thai cấp cứu ở Đại học Y Dược chênh nhau 210.000 đồng nhưng cột bảo hiểm y tế của cả hai đều là <b>50.600 đồng</b>. Một dòng ghi thẳng mức bảo hiểm y tế là <b>0 đồng</b>.",
 "bang": [
   {
     "ten": "Khám thai và siêu âm ở Bệnh viện Đại học Y Dược TP.HCM, phần có đủ hai cột",
     "kiem_chung": "chinh-thuc",
     "nguon": "Bệnh viện Đại học Y Dược TP.HCM, bảng giá dịch vụ khám bệnh chữa bệnh cơ sở 2 trên bvdaihoccoso2.com.vn, bản cập nhật 15/01/2026. Cột phần chênh là phép trừ của chúng tôi từ hai cột bệnh viện đăng.",
     "cot": ["Dịch vụ", "Giá dịch vụ", "Mức BHYT", "Phần chênh"],
     "hang": [
       ["Khám thai", "150.000đ", "<b>50.600đ</b>", "99.400đ"],
       ["Khám thai (cấp cứu)", "360.000đ", "<b>50.600đ</b>", "309.400đ"],
       ["Tư vấn chu sinh", "150.000đ", "<b>0đ</b>", "150.000đ"],
       ["Siêu âm thai", "212.000đ", "58.600đ", "153.400đ"],
       ["Siêu âm Doppler thai nhi", "543.000đ", "89.300đ", "453.700đ"],
     ],
   },
   {
     "ten": "Khám thai và siêu âm ở Bệnh viện Đa khoa Xuyên Á Củ Chi, phần có đủ hai cột",
     "kiem_chung": "chinh-thuc",
     "nguon": "Bệnh viện Đa khoa Xuyên Á, Bảng giá dịch vụ kỹ thuật 2025 đăng trên bvxuyena.com.vn, phần cơ sở Củ Chi. Cột phần chênh là phép trừ của chúng tôi từ hai cột bệnh viện đăng.",
     "cot": ["Dịch vụ", "Giá bệnh viện", "BHYT chi trả", "Phần chênh"],
     "hang": [
       ["Khám Phụ sản", "120.000đ", "<b>39.800đ</b>", "80.200đ"],
       ["Khám Phụ sản ngoài giờ", "150.000đ", "<b>39.800đ</b>", "110.200đ"],
       ["Khám cấp cứu", "150.000đ", "<b>39.800đ</b>", "110.200đ"],
       ["Siêu âm thai (thai, nhau thai, nước ối)", "180.000đ", "58.600đ", "121.400đ"],
       ["Siêu âm Doppler thai nhi", "360.000đ", "89.300đ", "270.700đ"],
       ["Siêu âm thai 3 tháng đầu (đo độ mờ da gáy)", "300.000đ", "58.600đ", "241.400đ"],
       ["Siêu âm thai 3 tháng giữa (Doppler màu 4D)", "468.000đ", "58.600đ", "409.400đ"],
     ],
   },
   {
     "ten": "Ba kỹ thuật, đặt cạnh nhau mức bảo hiểm y tế hai bệnh viện đăng",
     "kiem_chung": "chinh-thuc",
     "nguon": "Đối chiếu bảng giá cơ sở 2 Bệnh viện Đại học Y Dược TP.HCM bản 15/01/2026 với Bảng giá dịch vụ kỹ thuật 2025 của Bệnh viện Đa khoa Xuyên Á.",
     "cot": ["Kỹ thuật", "Mức BHYT ở Đại học Y Dược", "Mức BHYT ở Xuyên Á"],
     "hang": [
       ["Siêu âm thai", "58.600đ", "58.600đ"],
       ["Siêu âm Doppler thai nhi", "89.300đ", "89.300đ"],
       ["Khám thai / khám phụ sản", "50.600đ", "39.800đ"],
     ],
   },
 ],
 "y_chinh": [
   ["Giá khám đổi thì cột bảo hiểm y tế vẫn đứng yên",
    "Ở Đại học Y Dược, khám thai là 150.000 đồng và khám thai cấp cứu là 360.000 đồng, chênh nhau 210.000 đồng, nhưng cột mức bảo hiểm y tế của cả hai dòng đều ghi 50.600 đồng. Ở Xuyên Á, ba dòng khám có giá 120.000, 150.000 và 150.000 đồng, cột bảo hiểm y tế của cả ba đều ghi 39.800 đồng. Nói cách khác, toàn bộ 210.000 đồng đắt thêm của dòng cấp cứu nằm ngoài phần quỹ trả."],
   ["Hai bệnh viện, hai mức cho cùng một lần khám: 50.600 đồng và 39.800 đồng",
    "Chênh nhau 10.800 đồng, tức 1,27 lần. Cả hai bảng giá đều không giải thích vì sao. Chúng tôi chép lại đúng con số từng nơi đăng và không suy ra nguyên nhân."],
   ["Nhưng mức cho siêu âm thì giống hệt nhau ở cả hai nơi",
    "Siêu âm thai nhận 58.600 đồng ở cả hai bệnh viện. Siêu âm Doppler thai nhi nhận 89.300 đồng ở cả hai. Hai con số này cũng trùng với những gì chúng tôi đã đọc được hồi 17/09 khi rà giá siêu âm thai. Ba lần gặp lại cùng một cặp số ở ba bảng giá khác nhau thì nhiều khả năng đây là mức chung cho kỹ thuật, chứ không phải mức riêng của từng bệnh viện."],
   ["Siêu âm 4D đắt gấp 2,6 lần siêu âm thường, vẫn nhận đúng 58.600 đồng",
    "Bảng Xuyên Á có siêu âm thai 180.000 đồng và siêu âm thai 3 tháng giữa bằng Doppler màu 4D 468.000 đồng. Hai dòng cùng nhận 58.600 đồng. Phần chênh người bệnh đối diện là 121.400 đồng ở dòng thường và 409.400 đồng ở dòng 4D. Dòng đo độ mờ da gáy 300.000 đồng cũng vậy, vẫn 58.600 đồng."],
   ["Có một dòng ghi thẳng mức bảo hiểm y tế là 0 đồng",
    "Tư vấn chu sinh ở Đại học Y Dược, giá dịch vụ 150.000 đồng, cột mức bảo hiểm y tế ghi 0 đồng. Trong 12 dòng của bài này, chỉ dòng đó có cột bảo hiểm y tế bằng không. Bảng giá không nói vì sao."],
   ["Phần chênh trong bảng không phải là số tiền người bệnh móc túi",
    "Cột phần chênh chúng tôi tính ra chỉ là hiệu của hai cột bệnh viện đăng. Số tiền thực tế còn phụ thuộc mức hưởng ghi trên thẻ, 100%, 95% hay 80%, và mức hưởng đó áp vào phần thuộc phạm vi chi trả chứ không áp vào giá dịch vụ. Đi khám không đúng nơi đăng ký ban đầu lại là một cách tính khác nữa."],
   ["Khoản 4 Điều 23 loại trừ xét nghiệm và chẩn đoán thai không nhằm điều trị",
    "Luật Bảo hiểm y tế, khoản 4 Điều 23, ghi nguyên văn: &ldquo;Xét nghiệm, chẩn đoán thai không nhằm mục đích điều trị.&rdquo; Đây là một trong các trường hợp không thuộc phạm vi chi trả của quỹ. Điều đáng chú ý trong dữ liệu: Bệnh viện Phụ sản Hà Nội đăng sàng lọc trước sinh NIPS 3 nhiễm sắc thể 3.900.000 đồng và NIPS 23 nhiễm sắc thể 5.900.000 đồng, nhưng bảng của họ không có cột bảo hiểm y tế nào cho bất kỳ dòng nào. Chúng tôi không có tài liệu nói NIPS có rơi vào khoản 4 hay không, nên chỉ nêu điều luật và nêu dữ kiện, không kết luận thay."],
 ],
 "khong_ro": [
   "Hai bảng giá đều không giải thích vì sao mức bảo hiểm y tế cho một lần khám ở Đại học Y Dược là 50.600 đồng còn ở Xuyên Á là 39.800 đồng.",
   "Ba bệnh viện còn lại có bảng khám thai (Hùng Vương, Hạnh Phúc, Phụ sản Hà Nội) không đăng cột bảo hiểm y tế nào, nên bài này dừng ở 12 dòng.",
   "Bảng Xuyên Á ghi là Bảng giá dịch vụ kỹ thuật 2025, chúng tôi không biết đã có bản mới hơn hay chưa.",
   "Không tài liệu nào trong tay chúng tôi nói sàng lọc trước sinh NIPS thuộc hay không thuộc khoản 4 Điều 23.",
   "Bảng giá không cho biết mức bảo hiểm y tế ghi trong cột là phần quỹ trả sau khi đã nhân mức hưởng, hay là giá thuộc phạm vi chi trả trước khi nhân. Nên hỏi thẳng ở quầy thu ngân.",
 ],
 "faq": [
   ["Đi khám thai có được bảo hiểm y tế trả không?",
    "Hai bệnh viện trong dữ liệu đăng cột bảo hiểm y tế cho dòng khám thai: Đại học Y Dược ghi 50.600 đồng, Xuyên Á ghi 39.800 đồng. Còn xét nghiệm và chẩn đoán thai không nhằm mục đích điều trị thì khoản 4 Điều 23 Luật Bảo hiểm y tế xếp vào nhóm không thuộc phạm vi chi trả."],
   ["Khám thai cấp cứu thì bảo hiểm y tế trả nhiều hơn chứ?",
    "Theo bảng của Đại học Y Dược cơ sở 2 thì không. Dòng khám thai cấp cứu có giá dịch vụ 360.000 đồng, cao hơn dòng khám thai thường 210.000 đồng, nhưng cột mức bảo hiểm y tế của cả hai dòng vẫn là 50.600 đồng."],
   ["Siêu âm 4D có được bảo hiểm y tế trả cao hơn siêu âm thường không?",
    "Trong bảng của Xuyên Á thì không. Siêu âm thai 180.000 đồng và siêu âm Doppler màu 4D 468.000 đồng đều nhận 58.600 đồng."],
   ["Phần chênh trong bảng có phải là số tiền tôi phải trả không?",
    "Không hẳn. Đó là hiệu của hai cột bệnh viện đăng. Số tiền thật còn phụ thuộc mức hưởng trên thẻ và việc có khám đúng nơi đăng ký ban đầu hay không."],
 ],
 "lien_quan": ["di-kham-thai-mot-lan-het-bao-nhieu", "gia-mot-lan-sieu-am-thai", "muc-huong-bhyt-bao-nhieu-phan-tram"],
},

{
 ...
 "h1": "Thương tật toàn bộ vĩnh viễn được xác định thế nào",
 "desc": "Khoản 1 Điều 12 Thông tư 67/2023/TT-BTC đặt sàn cho quyền lợi này: sáu tổ hợp bộ phận cơ thể, hoặc tổn thương từ 81% trở lên, và một mốc chờ 180 ngày cho phần lớn trường hợp.",
 "tom_tat": "Trước Thông tư 67/2023/TT-BTC, mỗi hợp đồng tự định nghĩa thế nào là thương tật toàn bộ vĩnh viễn. Khoản 1 Điều 12 của thông tư này đặt một cái sàn chung: hoặc rơi vào <b>một trong sáu tổ hợp</b> bộ phận cơ thể bị mất hay liệt hoàn toàn, hoặc <b>tổn thương cơ thể từ 81% trở lên</b>. Và trừ trường hợp mất hoàn toàn bộ phận, việc chứng nhận <b>không được thực hiện sớm hơn 180 ngày</b>. Thông tư chỉ cho doanh nghiệp nới rộng quyền lợi so với sàn này, không cho thu hẹp.",
 "bang": [
   {
     "ten": "Sáu tổ hợp bộ phận cơ thể trong điểm a, trích nguyên văn",
     "kiem_chung": "chinh-thuc",
     "nguon": "Thông tư 67/2023/TT-BTC ngày 02/11/2023 của Bộ Tài chính, khoản 1 Điều 12, điểm a, gạch đầu dòng thứ nhất.",
     "cot": ["Tổ hợp", "Bộ phận"],
     "hang": [
       ["1", "hai tay"],
       ["2", "hai chân"],
       ["3", "một tay và một chân"],
       ["4", "hai mắt"],
       ["5", "một tay và một mắt"],
       ["6", "một chân và một mắt"],
     ],
   },
   {
     "ten": "Hai đường độc lập dẫn tới quyền lợi, theo điểm a",
     "kiem_chung": "chinh-thuc",
     "nguon": "Thông tư 67/2023/TT-BTC, khoản 1 Điều 12 điểm a, trích nguyên văn hai gạch đầu dòng.",
     "cot": ["Đường", "Nguyên văn"],
     "hang": [
       ["Theo bộ phận cơ thể", "&ldquo;Người được bảo hiểm bị mất, liệt hoàn toàn và không thể phục hồi được chức năng của: hai tay; hoặc hai chân; hoặc một tay và một chân; hoặc hai mắt; hoặc một tay và một mắt; hoặc một chân và một mắt.&rdquo;"],
       ["Theo tỷ lệ tổn thương", "&ldquo;Người được bảo hiểm bị tổn thương cơ thể <b>từ 81% trở lên</b> theo xác nhận của cơ quan y tế hoặc Hội đồng giám định Y khoa cấp tỉnh, thành phố trực thuộc Trung ương hoặc tổ chức giám định y tế hợp pháp được doanh nghiệp bảo hiểm, chi nhánh doanh nghiệp bảo hiểm phi nhân thọ nước ngoài chấp thuận.&rdquo;"],
     ],
   },
   {
     "ten": "Cách đo bộ phận cơ thể và thời điểm được chứng nhận, trích nguyên văn",
     "kiem_chung": "chinh-thuc",
     "nguon": "Thông tư 67/2023/TT-BTC, khoản 1 Điều 12, phần cuối điểm a và toàn bộ điểm b, trích nguyên văn.",
     "cot": ["Nội dung", "Nguyên văn"],
     "hang": [
       ["Đo tay từ đâu", "&ldquo;mất hoàn toàn, liệt hoàn toàn và không thể phục hồi được chức năng của tay được tính <b>từ cổ tay trở lên</b>&rdquo;"],
       ["Đo chân từ đâu", "&ldquo;mất hoàn toàn, liệt hoàn toàn và không thể phục hồi được chức năng của chân được tính <b>từ mắt cá chân trở lên</b>&rdquo;"],
       ["Mắt tính thế nào", "&ldquo;mất hoàn toàn và không thể phục hồi được chức năng của mắt được hiểu là mất hoàn toàn hoặc mù hoàn toàn&rdquo;"],
       ["Mất hoàn toàn bộ phận", "&ldquo;có thể được thực hiện ngay sau khi sự kiện bảo hiểm xảy ra hoặc sau khi kết thúc việc điều trị&rdquo;"],
       ["Liệt, mù, hoặc từ 81%", "&ldquo;được thực hiện <b>không sớm hơn 180 ngày</b> kể từ ngày xảy ra sự kiện bảo hiểm hoặc từ ngày bệnh lý được chẩn đoán&rdquo;"],
     ],
   },
 ],
 "y_chinh": [
   ["Cả sáu tổ hợp đều cần hai đơn vị, không tổ hợp nào chỉ gồm một",
    "Đọc kỹ danh sách ở điểm a: hai tay, hai chân, một tay và một chân, hai mắt, một tay và một mắt, một chân và một mắt. Không có dòng nào ghi mỗi một tay, hay mỗi một chân. Nghĩa là mất một tay, dù mất hoàn toàn, không tự nó đủ để rơi vào đường thứ nhất. Người trong tình huống đó phải đi đường thứ hai, tức chứng minh tổn thương cơ thể từ 81% trở lên."],
   ["Ngưỡng 81% là một cửa riêng, không phải điều kiện của cửa kia",
    "Điểm a liệt kê hai gạch đầu dòng và nối bằng câu &ldquo;khi xảy ra một trong các trường hợp sau&rdquo;. Ai rơi vào một trong sáu tổ hợp thì không cần giám định tỷ lệ phần trăm. Ngược lại, ai đạt 81% thì không cần tổn thương đúng những bộ phận kể trên. Hai đường độc lập, chỉ cần một."],
   ["Ranh giới đo là cổ tay và mắt cá chân",
    "Thông tư nói rõ tay tính từ cổ tay trở lên, chân tính từ mắt cá chân trở lên. Mất bàn tay là mất tay theo cách đo này. Mất ngón tay thì không, dù mất nhiều ngón. Đây là chỗ hay gây tranh cãi khi lập hồ sơ, và nay đã có câu chữ để đối chiếu."],
   ["Người bị liệt phải chờ 180 ngày, người mất hẳn bộ phận thì không",
    "Điểm b tách hai nhóm. Mất hoàn toàn bộ phận cơ thể thì chứng nhận được ngay sau sự kiện, hoặc sau khi kết thúc điều trị. Còn liệt hoàn toàn, mù hoàn toàn, hay tổn thương từ 81% trở lên thì việc chứng nhận không được sớm hơn 180 ngày. Mốc 180 ngày đó đếm từ ngày xảy ra sự kiện bảo hiểm, hoặc từ ngày bệnh lý được chẩn đoán. Thông tư ghi hai mốc và nối bằng chữ &ldquo;hoặc&rdquo;."],
   ["Ba nơi được xác nhận tỷ lệ 81%, và chỉ nơi thứ ba cần doanh nghiệp chấp thuận",
    "Câu chữ ở điểm a xếp thứ tự: cơ quan y tế, hoặc Hội đồng giám định Y khoa cấp tỉnh và thành phố trực thuộc Trung ương, hoặc tổ chức giám định y tế hợp pháp được doanh nghiệp chấp thuận. Mệnh đề &ldquo;được doanh nghiệp bảo hiểm chấp thuận&rdquo; gắn vào vế cuối cùng. Chỗ này đáng hỏi lại doanh nghiệp trước khi đi giám định ở đâu."],
   ["Điểm c chỉ cho nới rộng, không cho thu hẹp",
    "Nguyên văn: doanh nghiệp &ldquo;có thể bổ sung quy định về các trường hợp khác nhằm gia tăng quyền lợi thương tật toàn bộ vĩnh viễn cho người được bảo hiểm so với các trường hợp quy định tại điểm a, điểm b khoản này&rdquo;. Chữ gia tăng là chữ khoá. Một hợp đồng đặt điều kiện chặt hơn sàn này thì đang đi ngược câu chữ của thông tư."],
   ["Khoản 7 cho một hạn chót, và hạn đó đã qua",
    "Khoản 7 Điều 12 buộc doanh nghiệp rà soát và chỉnh sửa quy tắc, điều kiện, điều khoản để đáp ứng Điều này kể từ ngày 01/7/2025. Người đang giữ hợp đồng ký trước mốc đó nên đối chiếu định nghĩa trong bộ quy tắc của mình với câu chữ ở trên."],
   ["Ba việc nên làm",
    "Một, mở bộ quy tắc điều khoản của hợp đồng và tìm đúng mục thương tật toàn bộ vĩnh viễn, đọc xem định nghĩa ở đó có rộng bằng sàn của Điều 12 không. Hai, hỏi doanh nghiệp bằng văn bản xem họ chấp thuận kết quả giám định của những tổ chức nào. Ba, nếu thuộc nhóm liệt, mù hay tổn thương tỷ lệ cao thì ghi lại ngày xảy ra sự kiện và ngày được chẩn đoán, vì mốc 180 ngày đếm từ đó."],
 ],
 "khong_ro": [
   "Thông tư không nói tỷ lệ tổn thương cơ thể được đo theo bảng tỷ lệ nào. Chúng tôi chưa đọc được văn bản nào của Bộ Tài chính chỉ định bảng đó cho mục đích bảo hiểm thương mại.",
   "Thông tư không nói trường hợp vừa mất một tay vừa có tỷ lệ tổn thương dưới 81% thì xử lý ra sao. Đây là khoảng trống phải tra trong bộ quy tắc của từng hợp đồng.",
   "Khoản 7 Điều 12 đặt hạn rà soát là 01/7/2025. Chúng tôi không có tài liệu nào cho biết việc rà soát đã hoàn tất tới đâu.",
   "Bài này chỉ đọc khoản 1 Điều 12. Số tiền chi trả cho quyền lợi này là bao nhiêu thì thông tư không quy định, đó là việc của từng hợp đồng.",
 ],
 "faq": [
   ["Mất một tay có được coi là thương tật toàn bộ vĩnh viễn không?",
    "Theo điểm a khoản 1 Điều 12 thì không, vì cả sáu tổ hợp đều gồm hai đơn vị. Người mất một tay còn đường thứ hai là chứng minh tổn thương cơ thể từ 81% trở lên."],
   ["Mất bàn tay có tính là mất tay không?",
    "Có. Thông tư ghi rõ tay được tính từ cổ tay trở lên."],
   ["Vì sao phải chờ 180 ngày mới được chứng nhận?",
    "Thông tư không giải thích lý do, chỉ đặt ra mốc. Mốc này áp dụng cho trường hợp liệt hoàn toàn, mù hoàn toàn hoặc tổn thương từ 81% trở lên, không áp dụng cho trường hợp mất hẳn bộ phận cơ thể."],
   ["Hợp đồng của tôi định nghĩa chặt hơn thông tư thì sao?",
    "Điểm c chỉ cho phép doanh nghiệp bổ sung trường hợp nhằm gia tăng quyền lợi so với điểm a và điểm b. Khoản 7 Điều 12 buộc rà soát, chỉnh sửa từ ngày 01/7/2025. Nên đưa hai câu này ra khi trao đổi với doanh nghiệp."],
 ],
 "lien_quan": ["thoi-gian-cho-tung-loai-quyen-loi", "khi-nao-khong-duoc-tra-tien-bao-hiem", "ly-do-ho-so-bi-tu-choi-boi-thuong"],
},

{
 ...
 "h1": "Vay ngân hàng có bắt buộc mua bảo hiểm không",
 "desc": "Hai văn bản trả lời câu này theo hai cách khác nhau. Luật Các tổ chức tín dụng cấm gắn bán bảo hiểm không bắt buộc với dịch vụ ngân hàng. Thông tư 67 đặt thêm một cửa sổ 120 ngày quanh ngày giải ngân.",
 "tom_tat": "Câu trả lời ngắn là không. <b>Khoản 5 Điều 15 Luật Các tổ chức tín dụng số 32/2024/QH15</b>, hiệu lực từ 01/7/2024, xếp việc gắn bán bảo hiểm không bắt buộc với dịch vụ ngân hàng vào nhóm hành vi bị nghiêm cấm. Riêng với bảo hiểm liên kết đầu tư, <b>điểm c khoản 3 Điều 53 Thông tư 67/2023/TT-BTC</b> còn khoá thêm một cửa sổ: <b>60 ngày trước và 60 ngày sau</b> ngày giải ngân toàn bộ khoản vay. Hai quy định này có phạm vi khác nhau, và hay bị nhắc lẫn.",
 "bang": [
   {
     "ten": "Hai văn bản, hai phạm vi khác nhau",
     "kiem_chung": "chinh-thuc",
     "nguon": "Luật Các tổ chức tín dụng số 32/2024/QH15, Quốc hội thông qua ngày 18/01/2024, hiệu lực 01/7/2024, khoản 5 Điều 15. Thông tư 67/2023/TT-BTC ngày 02/11/2023 của Bộ Tài chính, điểm c khoản 3 Điều 53.",
     "cot": ["Văn bản", "Cấm cái gì", "Áp dụng khi nào"],
     "hang": [
       ["Luật Các tổ chức tín dụng 32/2024/QH15, khoản 5 Điều 15",
        "gắn bán <b>sản phẩm bảo hiểm không bắt buộc</b> với việc cung ứng sản phẩm, dịch vụ ngân hàng",
        "mọi lúc, dưới mọi hình thức"],
       ["Thông tư 67/2023/TT-BTC, điểm c khoản 3 Điều 53",
        "tư vấn, giới thiệu, chào bán, thu xếp giao kết hợp đồng <b>bảo hiểm liên kết đầu tư</b>",
        "trong <b>60 ngày trước và 60 ngày sau</b> ngày giải ngân toàn bộ khoản vay"],
     ],
   },
   {
     "ten": "Ba đoạn nguyên văn nên thuộc",
     "kiem_chung": "chinh-thuc",
     "nguon": "Luật Các tổ chức tín dụng số 32/2024/QH15, khoản 5 Điều 15. Thông tư 67/2023/TT-BTC, điểm a và điểm c khoản 3 Điều 53.",
     "cot": ["Nguồn", "Nguyên văn"],
     "hang": [
       ["Khoản 5 Điều 15 Luật 32/2024/QH15",
        "&ldquo;Tổ chức tín dụng, chi nhánh ngân hàng nước ngoài, người quản lý, người điều hành, nhân viên của tổ chức tín dụng, chi nhánh ngân hàng nước ngoài gắn việc bán sản phẩm bảo hiểm không bắt buộc với việc cung ứng sản phẩm, dịch vụ ngân hàng dưới mọi hình thức.&rdquo;"],
       ["Điểm a khoản 3 Điều 53 Thông tư 67",
        "&ldquo;Giải thích cho bên mua bảo hiểm các sản phẩm bảo hiểm được phân phối thông qua tổ chức hoạt động đại lý bảo hiểm là sản phẩm bảo hiểm. <b>Việc tham gia sản phẩm bảo hiểm không phải là điều kiện bắt buộc để sử dụng các sản phẩm, dịch vụ khác của tổ chức hoạt động đại lý.</b>&rdquo;"],
       ["Điểm c khoản 3 Điều 53 Thông tư 67",
        "&ldquo;Tổ chức tín dụng, chi nhánh ngân hàng nước ngoài thực hiện hoạt động đại lý bảo hiểm không được tư vấn, giới thiệu, chào bán, thu xếp việc giao kết hợp đồng bảo hiểm liên kết đầu tư cho các khách hàng trong <b>60 ngày trước và 60 ngày sau ngày giải ngân toàn bộ khoản vay</b>.&rdquo;"],
     ],
   },
   {
     "ten": "Nội dung buổi tư vấn bảo hiểm liên kết đầu tư phải được ghi âm, theo khoản 2 Điều 53",
     "kiem_chung": "chinh-thuc",
     "nguon": "Thông tư 67/2023/TT-BTC, khoản 2 Điều 53, các điểm b, c, d và đ.",
     "cot": ["Điểm", "Nghĩa vụ của bên bán"],
     "hang": [
       ["b", "phân tích nhu cầu tài chính và khảo sát mức độ chấp nhận rủi ro của khách hàng, chỉ ra công cụ tính toán và quy tắc sản phẩm trên trang thông tin của doanh nghiệp"],
       ["c", "giải thích rõ quyền lợi sản phẩm và các rủi ro đặc thù, và yêu cầu khách hàng xác nhận vào tài liệu"],
       ["d", "<b>không được so sánh</b> hoặc bảo đảm kết quả đầu tư của một quỹ tốt hơn quỹ khác"],
       ["đ", "<b>ghi âm</b> nội dung tư vấn về quyền lợi bảo hiểm, quyền lợi đầu tư và các rủi ro, kèm thông báo về phí, thời gian cân nhắc, quyền và nghĩa vụ, và xác nhận khách hàng tự nguyện tham gia"],
     ],
   },
 ],
 "y_chinh": [
   ["Điều cấm nằm trong Luật, không phải trong một hướng dẫn nội bộ",
    "Khoản 5 Điều 15 Luật Các tổ chức tín dụng số 32/2024/QH15 nằm trong điều có tên là hành vi bị nghiêm cấm, và điều này có đúng năm khoản. Luật được Quốc hội thông qua ngày 18/01/2024 và có hiệu lực từ 01/7/2024. Câu chữ nhắm cả tổ chức lẫn cá nhân: tổ chức tín dụng, chi nhánh ngân hàng nước ngoài, người quản lý, người điều hành và nhân viên."],
   ["Hai chữ không bắt buộc là chỗ phân định",
    "Luật cấm gắn bán <b>sản phẩm bảo hiểm không bắt buộc</b>. Có những loại bảo hiểm mà pháp luật hoặc hợp đồng tín dụng đòi hỏi, chẳng hạn bảo hiểm cho tài sản thế chấp, và đó là chuyện khác. Câu nên hỏi ở quầy là: khoản bảo hiểm này thuộc loại bắt buộc theo quy định nào, hay là sản phẩm tự nguyện."],
   ["Cửa sổ của Thông tư 67 là 120 ngày, và chỉ dành cho một loại sản phẩm",
    "Điểm c khoản 3 Điều 53 khoá 60 ngày trước cộng 60 ngày sau, tổng cộng 120 ngày. Nhưng nó chỉ nói tới <b>bảo hiểm liên kết đầu tư</b>. Một sản phẩm bảo hiểm khác được chào bán trong cửa sổ đó không rơi vào điểm c này, dù vẫn có thể rơi vào khoản 5 Điều 15 của Luật nếu bị gắn thành điều kiện."],
   ["Mốc đếm là ngày giải ngân toàn bộ, không phải ngày ký hợp đồng vay",
    "Nguyên văn ghi &ldquo;ngày giải ngân toàn bộ khoản vay&rdquo;. Với khoản vay giải ngân làm nhiều đợt, mốc là đợt cuối cùng chứ không phải đợt đầu. Ai ký hợp đồng vay tháng này nhưng nhận tiền làm ba đợt tới tháng sau thì cửa sổ 60 ngày sau chỉ bắt đầu đếm khi nhận xong."],
   ["Có một câu bên bán buộc phải nói ra, và nó được viết sẵn trong thông tư",
    "Điểm a khoản 3 Điều 53 buộc giải thích rằng việc tham gia sản phẩm bảo hiểm không phải là điều kiện bắt buộc để sử dụng các sản phẩm, dịch vụ khác. Đây là nghĩa vụ của bên bán, không phải là câu khách hàng phải tự hỏi. Nếu không ai nói câu này thì nghĩa vụ đó chưa được thực hiện."],
   ["Buổi tư vấn liên kết đầu tư phải có bản ghi âm",
    "Điểm đ khoản 2 Điều 53 liệt kê những gì bản ghi âm phải chứa: nội dung tư vấn về quyền lợi bảo hiểm, quyền lợi đầu tư và các rủi ro, thông báo về phí, thời gian cân nhắc, quyền và nghĩa vụ, và xác nhận khách hàng tự nguyện tham gia. Người mua có quyền hỏi bản ghi âm đó tồn tại hay không, vì chính thông tư buộc phải có."],
   ["Điểm d cấm so sánh quỹ, và cấm cả lời bảo đảm",
    "Bên bán không được so sánh hay bảo đảm kết quả đầu tư của một quỹ tốt hơn quỹ khác. Lời hứa về mức sinh lời của một quỹ liên kết đầu tư, nói miệng hay viết ra, đều đi ngược điểm này."],
   ["Bốn việc nên làm khi đi vay",
    "Một, hỏi thẳng khoản bảo hiểm được chào là bắt buộc theo quy định nào hay tự nguyện, và đề nghị trả lời bằng văn bản. Hai, ghi lại ngày giải ngân đợt cuối, vì đó là mốc của cửa sổ 120 ngày. Ba, nếu sản phẩm được chào là bảo hiểm liên kết đầu tư thì hỏi về bản ghi âm buổi tư vấn. Bốn, giữ lại tin nhắn và email trao đổi quanh thời điểm giải ngân."],
 ],
 "khong_ro": [
   "Thông tư 67/2023/TT-BTC không quy định chế tài khi vi phạm cửa sổ 120 ngày. Chúng tôi chưa đọc được văn bản xử phạt tương ứng nên không nêu mức phạt nào.",
   "Luật Các tổ chức tín dụng không liệt kê nơi tiếp nhận khiếu nại cho riêng hành vi ở khoản 5 Điều 15. Bài này không nêu địa chỉ khiếu nại vì chưa có nguồn để dẫn.",
   "Hai văn bản không nói hợp đồng bảo hiểm đã ký trong cửa sổ 120 ngày thì có bị vô hiệu hay không. Đây là câu hỏi phải tra ở quy định về hợp đồng vô hiệu, không nằm trong hai điều khoản bài này đọc.",
   "Chúng tôi không có số liệu nào về số vụ vi phạm đã bị xử lý, nên bài này chỉ nói về câu chữ của quy định.",
 ],
 "faq": [
   ["Ngân hàng nói không mua bảo hiểm thì không được vay, như vậy có đúng luật không?",
    "Khoản 5 Điều 15 Luật Các tổ chức tín dụng số 32/2024/QH15 xếp việc gắn bán sản phẩm bảo hiểm không bắt buộc với cung ứng sản phẩm, dịch vụ ngân hàng vào nhóm hành vi bị nghiêm cấm, dưới mọi hình thức. Điều cần làm rõ trước là khoản bảo hiểm đó thuộc loại bắt buộc hay tự nguyện."],
   ["Cửa sổ 60 ngày trước và sau áp dụng cho mọi loại bảo hiểm phải không?",
    "Không. Điểm c khoản 3 Điều 53 Thông tư 67/2023/TT-BTC chỉ nói tới bảo hiểm liên kết đầu tư."],
   ["Khoản vay giải ngân nhiều đợt thì tính mốc nào?",
    "Nguyên văn ghi ngày giải ngân toàn bộ khoản vay, tức đợt cuối cùng."],
   ["Tôi có quyền yêu cầu nghe lại bản ghi âm buổi tư vấn không?",
    "Điểm đ khoản 2 Điều 53 buộc bên bán ghi âm nội dung tư vấn đối với sản phẩm bảo hiểm liên kết đầu tư. Thông tư buộc phải có bản ghi âm đó, nhưng không quy định thủ tục để khách hàng yêu cầu nghe lại. Chúng tôi không dẫn thủ tục nào vì chưa có nguồn."],
 ],
 "lien_quan": ["21-ngay-can-nhac-hop-dong-bao-hiem", "ke-khai-sai-khi-mua-bao-hiem", "huy-hop-dong-va-lay-lai-duoc-bao-nhieu"],
},

{
 ...
 "h1": "Hoa hồng đại lý bảo hiểm tối đa bao nhiêu phần trăm",
 "desc": "Bộ Tài chính đặt trần hoa hồng theo từng nghiệp vụ, từng năm hợp đồng và từng phương thức nộp phí. Cao nhất là 40% ở năm đầu, thấp nhất là 5%. Bảo hiểm sức khoẻ có một mức phẳng 20%.",
 "tom_tat": "Hoa hồng đại lý không do doanh nghiệp tự đặt bao nhiêu cũng được. Điều 51 Thông tư 67/2023/TT-BTC đặt trần cho từng nghiệp vụ, và <b>Thông tư 96/2026/TT-BTC</b> ban hành ngày 02/7/2026 sửa lại bảng này, áp dụng cho hợp đồng nhân thọ cá nhân từ <b>01/01/2027</b>. Mức cao nhất là <b>40%</b> cho năm hợp đồng đầu tiên của bảo hiểm tử kỳ và trọn đời nộp phí định kỳ. Thấp nhất trong bảng là <b>5%</b>. Bảo hiểm sức khoẻ có một mức phẳng <b>20%</b>. Đây là trần pháp lý, không phải mức một đại lý cụ thể được nhận.",
 "bang": [
   {
     "ten": "Trần hoa hồng cho hợp đồng bảo hiểm nhân thọ cá nhân, áp dụng từ 01/01/2027",
     "kiem_chung": "thu-cap",
     "nguon": "Thông tư 96/2026/TT-BTC ngày 02/7/2026 của Bộ Tài chính, sửa tiết a điểm 3.2 khoản 3 Điều 51 Thông tư 67/2023/TT-BTC. Chúng tôi đọc bảng này qua bản trên thuvienphapluat.vn và đối chiếu với bản Thông tư 67 trên hethongphapluat.com ngày 25/09/2026; các con số ở hai nơi trùng nhau. Chưa đối chiếu được với bản PDF có chữ ký.",
     "cot": ["Nghiệp vụ bảo hiểm", "Thời hạn hợp đồng", "Nộp phí định kỳ: năm 1 / năm 2 / năm tiếp theo", "Nộp phí một lần"],
     "hang": [
       ["Tử kỳ, Trọn đời", "trên 1 năm", "<b>40%</b> / 20% / 15%", "15%"],
       ["Sinh kỳ, Trả tiền định kỳ, Hỗn hợp", "trên 1 năm tới 10 năm", "25% / 7% / <b>5%</b>", "5%"],
       ["Sinh kỳ, Trả tiền định kỳ, Hỗn hợp", "trên 10 năm", "30% / 20% / 10%", "7%"],
       ["Liên kết chung, Liên kết đơn vị", "trên 1 năm", "30% / 20% / 10%", "7%"],
       ["Mọi nghiệp vụ trong nhóm trên", "từ 1 năm trở xuống, và 1 năm tái tục hàng năm", "20%", "20%"],
     ],
   },
   {
     "ten": "Trần hoa hồng cho hợp đồng thuộc bảo hiểm sức khoẻ",
     "kiem_chung": "chinh-thuc",
     "nguon": "Thông tư 67/2023/TT-BTC, điểm 3.3 khoản 3 Điều 51, trích nguyên văn.",
     "cot": ["Nhóm hợp đồng", "Nguyên văn"],
     "hang": [
       ["Bảo hiểm sức khoẻ", "&ldquo;Tỷ lệ hoa hồng đại lý bảo hiểm tối đa đối với các hợp đồng bảo hiểm thuộc bảo hiểm sức khỏe: <b>20%</b>&rdquo;"],
     ],
   },
   {
     "ten": "Thưởng và hỗ trợ đại lý là khoản thứ hai, có trần riêng",
     "kiem_chung": "chinh-thuc",
     "nguon": "Thông tư 67/2023/TT-BTC, khoản 2 Điều 52, trích nguyên văn điểm a và điểm b.",
     "cot": ["Điểm", "Nguyên văn"],
     "hang": [
       ["a", "&ldquo;Tổng các khoản thưởng, hỗ trợ đại lý bảo hiểm và các quyền lợi khác của đại lý trong mỗi năm tài chính không vượt quá tổng giá trị của <b>20%</b> phí bảo hiểm thực tế thu được của các hợp đồng bảo hiểm có thời hạn từ 01 năm trở xuống và 01 năm tái tục hàng năm và <b>30%</b> phí bảo hiểm khai thác năm đầu thực tế thu được đối với các hợp đồng bảo hiểm có thời hạn trên 01 năm.&rdquo;"],
       ["b", "&ldquo;Tổng các khoản thưởng, hỗ trợ đại lý bảo hiểm và các quyền lợi khác trong mỗi năm tài chính không vượt quá <b>7%</b> phí bảo hiểm tái tục thực tế thu được trong năm.&rdquo;"],
     ],
   },
   {
     "ten": "Hai văn bản đang chi phối bảng trần, và mốc thời gian của từng cái",
     "kiem_chung": "chinh-thuc",
     "nguon": "Thông tư 67/2023/TT-BTC ngày 02/11/2023. Thông tin về Thông tư 96/2026/TT-BTC lấy từ trang văn bản của Chính phủ vanban.chinhphu.vn, đọc ngày 25/09/2026.",
     "cot": ["Văn bản", "Ngày ban hành", "Vai trò"],
     "hang": [
       ["Thông tư 67/2023/TT-BTC", "02/11/2023", "đặt bảng trần gốc tại Điều 51, và trần thưởng hỗ trợ tại Điều 52"],
       ["Thông tư 96/2026/TT-BTC, Thứ trưởng Lê Tấn Cận ký", "02/7/2026", "sửa bảng trần nhân thọ cá nhân, phần này áp dụng từ <b>01/01/2027</b>"],
     ],
   },
 ],
 "y_chinh": [
   ["Hoa hồng là khoản doanh nghiệp chi ra, không phải khoản cộng thêm vào phí",
    "Khoản 1 Điều 51 ghi nguyên văn: doanh nghiệp bảo hiểm &ldquo;trả hoa hồng đại lý bảo hiểm theo quy định tại khoản 3 Điều này cho đại lý bảo hiểm sau khi đại lý bảo hiểm mang lại dịch vụ&rdquo;. Câu chữ nói rõ chiều tiền: từ doanh nghiệp sang đại lý. Người mua không trả thêm một khoản riêng tên là hoa hồng."],
   ["Mọi dòng trong bảng đều giảm dần theo năm hợp đồng",
    "Tử kỳ và trọn đời đi 40% rồi 20% rồi 15%. Hỗn hợp trên 10 năm đi 30% rồi 20% rồi 10%. Hỗn hợp từ 10 năm trở xuống đi 25% rồi 7% rồi 5%. Không dòng nào tăng lên hay đi ngang. Nghĩa là phần lớn thu nhập của đại lý từ một hợp đồng rơi vào năm đầu tiên."],
   ["Nộp phí một lần có trần thấp hơn hẳn nộp phí định kỳ",
    "Cùng nghiệp vụ tử kỳ và trọn đời, năm đầu nộp định kỳ trần 40% còn nộp một lần trần 15%. Cùng nghiệp vụ liên kết, 30% so với 7%. Cùng nhóm hỗn hợp từ 10 năm trở xuống, 25% so với 5%. Khoảng cách này lớn hơn nhiều người tưởng."],
   ["Hợp đồng dài hơn mười năm có trần cao hơn hợp đồng ngắn hơn, dù cùng nghiệp vụ",
    "Ba nghiệp vụ sinh kỳ, trả tiền định kỳ và hỗn hợp nằm ở hai dòng khác nhau chỉ vì thời hạn. Dưới mốc mười năm là 25% rồi 7% rồi 5%. Trên mốc mười năm là 30% rồi 20% rồi 10%. Riêng năm hợp đồng thứ hai chênh nhau gần ba lần."],
   ["Liên kết chung và liên kết đơn vị đi chung một dòng với hỗn hợp dài hạn",
    "Cả hai nghiệp vụ liên kết đầu tư nhận trần 30% rồi 20% rồi 10% khi nộp phí định kỳ, và 7% khi nộp một lần, đúng bằng nhóm hỗn hợp trên mười năm. Bảng không tách riêng liên kết đơn vị khỏi liên kết chung."],
   ["Bảo hiểm sức khoẻ chỉ có một mức phẳng",
    "Điểm 3.3 khoản 3 Điều 51 ghi đúng một con số: 20%. Không chia theo năm hợp đồng, không chia theo phương thức nộp phí, không chia theo thời hạn. Đây là nhóm có quy định gọn nhất trong cả điều."],
   ["Thưởng và hỗ trợ là khoản thứ hai, và tính theo năm tài chính chứ không theo hợp đồng",
    "Điều 52 khoản 2 đặt trần riêng: 20% phí thực thu của hợp đồng từ một năm trở xuống, 30% phí khai thác năm đầu của hợp đồng trên một năm, và 7% phí tái tục thực thu. Cả ba con số tính trên tổng của một năm tài chính, không tính trên từng hợp đồng. Đây là lý do không cộng thẳng con số này vào tỷ lệ hoa hồng của một hợp đồng cụ thể."],
   ["Đây là trần, không phải mức thực tế",
    "Thông tư đặt mức tối đa. Doanh nghiệp tự quyết mức thực trả trong giới hạn đó, và mức thực trả không được công bố. Con số trong bảng cho biết pháp luật cho phép tới đâu, không cho biết một đại lý cụ thể nhận bao nhiêu."],
   ["Ba câu đáng hỏi khi đọc bảng này",
    "Một, hợp đồng đang cân nhắc thuộc nghiệp vụ nào trong bảng, vì trần chênh nhau nhiều lần giữa các nghiệp vụ. Hai, thời hạn hợp đồng nằm trên hay dưới mốc mười năm, vì đúng mốc đó chia đôi bảng. Ba, nộp phí định kỳ hay một lần, vì hai cột cho hai con số rất khác nhau."],
 ],
 "khong_ro": [
   "Chúng tôi chưa đọc được bản PDF có chữ ký của Thông tư 96/2026/TT-BTC. Trang văn bản của Chính phủ chỉ đăng thông tin văn bản và liên kết tải file. Bảng trần trong bài vì thế gắn nhãn thứ cấp, dù con số đọc được ở hai cơ sở dữ liệu pháp luật trùng khớp nhau.",
   "Chúng tôi không xác định được Thông tư 96/2026 đã đổi đúng chỗ nào so với bảng cũ của Thông tư 67. Nguồn chỉ ghi là sửa tiết a điểm 3.2 khoản 3 Điều 51.",
   "Trần hoa hồng cho bảo hiểm hưu trí, bảo hiểm phi nhân thọ và bảo hiểm nhóm không nằm trong bài này.",
   "Không có con số thực trả của bất kỳ doanh nghiệp bảo hiểm nào trong bài này, vì không doanh nghiệp nào công bố.",
 ],
 "faq": [
   ["Mua bảo hiểm thì tôi có phải trả tiền hoa hồng cho đại lý không?",
    "Khoản 1 Điều 51 Thông tư 67/2023/TT-BTC ghi rõ doanh nghiệp bảo hiểm là bên trả hoa hồng cho đại lý. Đây không phải khoản người mua nộp riêng."],
   ["Hoa hồng cao nhất trong bảng là bao nhiêu?",
    "40%, dành cho năm hợp đồng đầu tiên của bảo hiểm tử kỳ và bảo hiểm trọn đời có thời hạn trên một năm, nộp phí định kỳ. Đây là mức trần, không phải mức thực trả."],
   ["Vì sao cùng một loại bảo hiểm mà có hai dòng trần khác nhau?",
    "Vì bảng chia theo thời hạn hợp đồng. Ba nghiệp vụ sinh kỳ, trả tiền định kỳ và hỗn hợp có một dòng cho hợp đồng tới mười năm và một dòng cho hợp đồng trên mười năm."],
   ["Bảng này áp dụng từ khi nào?",
    "Phần bảng trần cho hợp đồng nhân thọ cá nhân áp dụng từ 01/01/2027, theo Thông tư 96/2026/TT-BTC ban hành ngày 02/7/2026."],
 ],
 "lien_quan": ["vay-ngan-hang-co-phai-mua-bao-hiem-khong", "21-ngay-can-nhac-hop-dong-bao-hiem", "ke-khai-sai-khi-mua-bao-hiem"],
},

{
 ...
 "h1": "Tạm ứng từ giá trị hoàn lại tính lãi thế nào",
 "desc": "Khoản 4 Điều 12 Thông tư 67/2023/TT-BTC chặn lãi suất tạm ứng ở mức lãi suất tích luỹ doanh nghiệp công bố cộng 2%, và nêu một mốc thay thế cho trường hợp doanh nghiệp không công bố.",
 "tom_tat": "Rút tạm một phần giá trị hoàn lại của hợp đồng nhân thọ thì bị tính lãi, và phần lãi đó có trần. Khoản 4 Điều 12 Thông tư 67/2023/TT-BTC chặn ở <b>lãi suất tích luỹ do doanh nghiệp công bố cộng với 2%</b>. Nếu doanh nghiệp không công bố lãi suất tích luỹ thì mốc chuyển sang <b>lãi suất đầu tư của quỹ chủ hợp đồng không tham gia chia lãi trong năm tài chính liền kề trước đó, cộng 2%</b>. Điểm c loại trừ hai nhóm sản phẩm: <b>liên kết đầu tư và hưu trí</b>.",
 "bang": [
   {
     "ten": "Toàn văn khoản 4 Điều 12, bốn đoạn",
     "kiem_chung": "chinh-thuc",
     "nguon": "Thông tư 67/2023/TT-BTC ngày 02/11/2023 của Bộ Tài chính, khoản 4 Điều 12, trích nguyên văn.",
     "cot": ["Điểm", "Nguyên văn"],
     "hang": [
       ["Câu mở đầu", "&ldquo;Trường hợp quy tắc, điều kiện, điều khoản của hợp đồng bảo hiểm nhân thọ <b>có quy định</b> việc tạm ứng từ giá trị hoàn lại, việc tạm ứng từ giá trị hoàn lại phải đáp ứng các quy định sau&rdquo;"],
       ["a", "&ldquo;Mức lãi suất tính cho phần tạm ứng từ giá trị hoàn lại không được vượt quá lãi suất tích lũy do doanh nghiệp bảo hiểm công bố cho khách hàng <b>cộng với 2%</b>. Trường hợp không công bố lãi suất tích lũy, mức lãi suất tạm ứng không được vượt quá lãi suất đầu tư của quỹ chủ hợp đồng không tham gia chia lãi trong năm tài chính liền kề trước đó cộng với 2%.&rdquo;"],
       ["b", "&ldquo;Trường hợp quy tắc, điều kiện, điều khoản bảo hiểm có quy định cho phép bên mua bảo hiểm dừng đóng phí bảo hiểm và sử dụng giá trị hoàn lại để duy trì hiệu lực hợp đồng thì phải đảm bảo phù hợp với quy định tại khoản 4 Điều 37 Luật Kinh doanh bảo hiểm.&rdquo;"],
       ["c", "&ldquo;Việc tạm ứng từ giá trị hoàn lại <b>không áp dụng với sản phẩm liên kết đầu tư, hưu trí</b>.&rdquo;"],
     ],
   },
   {
     "ten": "Hai cách tính trần, tuỳ doanh nghiệp có công bố lãi suất tích luỹ hay không",
     "kiem_chung": "chinh-thuc",
     "nguon": "Thông tư 67/2023/TT-BTC, điểm a khoản 4 Điều 12.",
     "cot": ["Trường hợp", "Mốc để tính trần"],
     "hang": [
       ["Doanh nghiệp có công bố lãi suất tích luỹ cho khách hàng", "lãi suất tích luỹ đã công bố, cộng 2%"],
       ["Doanh nghiệp không công bố lãi suất tích luỹ", "lãi suất đầu tư của quỹ chủ hợp đồng không tham gia chia lãi trong năm tài chính liền kề trước đó, cộng 2%"],
     ],
   },
 ],
 "y_chinh": [
   ["Con số 2% là khoảng cộng thêm, không phải lãi suất",
    "Câu chữ ghi &ldquo;không được vượt quá lãi suất tích lũy do doanh nghiệp bảo hiểm công bố cho khách hàng cộng với 2%&rdquo;. Nghĩa là trần bằng một con số thả nổi cộng thêm hai điểm phần trăm. Lãi suất tích luỹ công bố là 5% thì trần là 7%. Đọc nhầm thành lãi tạm ứng bằng 2% là hiểu ngược hẳn."],
   ["Điểm a có hai vế, và vế thứ hai mới là chỗ hay bị bỏ qua",
    "Vế đầu áp dụng khi doanh nghiệp có công bố lãi suất tích luỹ. Vế sau dành cho trường hợp không công bố, và khi đó mốc chuyển sang lãi suất đầu tư của quỹ chủ hợp đồng không tham gia chia lãi, lấy của năm tài chính liền kề trước đó. Hai mốc khác nhau, và người giữ hợp đồng cần biết hợp đồng của mình rơi vào vế nào."],
   ["Cả khoản này chỉ chạy khi hợp đồng có quy định việc tạm ứng",
    "Câu mở đầu ghi rõ &ldquo;Trường hợp quy tắc, điều kiện, điều khoản của hợp đồng bảo hiểm nhân thọ có quy định việc tạm ứng&rdquo;. Không phải hợp đồng nhân thọ nào cũng cho tạm ứng. Trần lãi suất ở điểm a không tạo ra quyền tạm ứng, nó chỉ giới hạn cách tính lãi khi quyền đó đã có sẵn trong hợp đồng."],
   ["Hai nhóm sản phẩm bị loại thẳng khỏi cơ chế này",
    "Điểm c ghi &ldquo;không áp dụng với sản phẩm liên kết đầu tư, hưu trí&rdquo;. Người giữ hợp đồng liên kết chung, liên kết đơn vị hoặc hưu trí không dùng được đường tạm ứng từ giá trị hoàn lại theo khoản này."],
   ["Dừng đóng phí để duy trì hợp đồng là chuyện khác, và đi theo điều luật khác",
    "Điểm b tách riêng việc bên mua dừng đóng phí và dùng giá trị hoàn lại để giữ hợp đồng còn hiệu lực. Việc đó phải phù hợp với khoản 4 Điều 37 Luật Kinh doanh bảo hiểm, không phải với trần lãi suất ở điểm a. Hai cơ chế thường bị gộp làm một khi tư vấn nói nhanh."],
   ["Vì sao nên hỏi con số lãi suất tích luỹ trước khi tạm ứng",
    "Trần lãi suất phụ thuộc hoàn toàn vào con số đó, và nó thay đổi theo từng năm. Không biết lãi suất tích luỹ hiện hành thì không kiểm được mức lãi doanh nghiệp đang tính có nằm trong trần hay không."],
   ["Ba việc nên làm trước khi rút tạm",
    "Một, mở bộ quy tắc điều khoản và xác nhận hợp đồng có điều khoản tạm ứng từ giá trị hoàn lại hay không. Hai, hỏi doanh nghiệp bằng văn bản về lãi suất tích luỹ đang công bố, hoặc lãi suất đầu tư của quỹ chủ hợp đồng không tham gia chia lãi của năm tài chính liền kề trước nếu họ không công bố lãi suất tích luỹ. Ba, đối chiếu mức lãi ghi trên phiếu tạm ứng với con số vừa hỏi cộng thêm hai điểm phần trăm."],
 ],
 "khong_ro": [
   "Thông tư không quy định được tạm ứng tối đa bao nhiêu phần trăm giá trị hoàn lại. Đó là việc của từng hợp đồng.",
   "Thông tư không đặt hạn phải hoàn lại khoản tạm ứng, cũng không nói hậu quả khi khoản tạm ứng cộng lãi vượt quá giá trị hoàn lại.",
   "Bài này chỉ đọc khoản 4 Điều 12. Nội dung khoản 4 Điều 37 Luật Kinh doanh bảo hiểm mà điểm b dẫn chiếu tới thì chúng tôi chưa đọc trong bài này.",
   "Không có con số lãi suất tích luỹ thực tế của doanh nghiệp nào trong bài, vì đó là con số từng doanh nghiệp công bố riêng và thay đổi theo năm.",
 ],
 "faq": [
   ["Tạm ứng từ giá trị hoàn lại bị tính lãi bao nhiêu?",
    "Thông tư không đưa ra một con số cố định. Trần bằng lãi suất tích luỹ doanh nghiệp công bố cho khách hàng cộng với 2%. Nếu doanh nghiệp không công bố lãi suất tích luỹ thì mốc là lãi suất đầu tư của quỹ chủ hợp đồng không tham gia chia lãi trong năm tài chính liền kề trước đó, cộng 2%."],
   ["Hợp đồng liên kết đơn vị có tạm ứng được không?",
    "Điểm c khoản 4 Điều 12 ghi việc tạm ứng từ giá trị hoàn lại không áp dụng với sản phẩm liên kết đầu tư và hưu trí."],
   ["Hợp đồng nhân thọ nào cũng cho tạm ứng phải không?",
    "Không. Câu mở đầu khoản 4 chỉ áp dụng cho trường hợp quy tắc, điều kiện, điều khoản của hợp đồng có quy định việc tạm ứng."],
   ["Dừng đóng phí mà vẫn giữ hợp đồng có phải là tạm ứng không?",
    "Đó là cơ chế khác. Điểm b tách riêng và dẫn chiếu sang khoản 4 Điều 37 Luật Kinh doanh bảo hiểm."],
 ],
 "lien_quan": ["huy-hop-dong-va-lay-lai-duoc-bao-nhieu", "dong-phi-tre-va-khoi-phuc-hop-dong", "thoi-gian-cho-tung-loai-quyen-loi"],
},

{
 "slug": "sinh-thuong-ton-bao-nhieu",
 "cum": "A",
 "ngay_dang": "2026-09-24",
 "tag": "Thai sản",
 "doc": "8 phút đọc",
 "title": "Đẻ thường hết bao nhiêu tiền: công đỡ đẻ từ 706.000 đồng, gói sanh thường ở bệnh viện tư từ 17,1 triệu đồng",
 "h1": "Sinh thường tốn bao nhiêu tiền",
 "desc": "Tiền công đỡ đẻ thường ở bệnh viện công từ 706.000 đồng tới 5.900.000 đồng. Gói sinh thường ở bệnh viện tư từ 17.100.000 đồng, nhưng gói rẻ nhất chưa gồm phí bác sĩ, thuốc và vật tư.",
 "tom_tat": "Chúng tôi rà biểu giá của 21 bệnh viện tính tới ngày 24/09/2026 và tách hai loại con số hay bị trộn lẫn. Loại thứ nhất là <b>tiền công một ca đỡ đẻ thường</b>, ghi trong bảng giá thủ thuật: thấp nhất <b>706.000 đồng</b> ở Phụ sản Trung ương, cao nhất 5.900.000 đồng ở Đại học Y Dược TP.HCM. Loại thứ hai là <b>gói sinh</b> ở bệnh viện tư và quốc tế: rẻ nhất <b>17.100.000 đồng</b> ở Quốc tế City, nhưng gói đó chưa gồm phí bác sĩ, thuốc và vật tư. Hai loại này không so với nhau được.",
 "bang": [
   {
     "ten": "Tiền công đỡ đẻ thường ngôi chỏm ở bốn bệnh viện: năm mức giá",
     "kiem_chung": "chinh-thuc",
     "nguon": "Bệnh viện Phụ sản Trung ương, file danh-muc-gia-dich-vu.pdf, mã TS003, file không ghi ngày ban hành và không ghi số quyết định. Bệnh viện Phụ sản Hà Nội, bảng giá sinh khu thường và khu dịch vụ, đăng 20/08/2026. Bệnh viện Đa khoa Xuyên Á, Bảng giá dịch vụ kỹ thuật 2025, cơ sở Củ Chi. Bệnh viện Đại học Y Dược TP.HCM, Quyết định 1364/QĐ-ĐHYD ngày 16/07/2020, bảng giá cơ sở 1 đăng 20/12/2020.",
     "cot": ["Bệnh viện", "Giá bệnh viện ghi", "Cột BHYT cùng dòng", "Mốc văn bản"],
     "hang": [
       ["Phụ sản Trung ương", "<b>706.000đ</b>", "không có cột", "không ghi ngày"],
       ["Phụ sản Hà Nội, khu thường", "786.700đ", "không có cột", "20/08/2026"],
       ["Xuyên Á, cơ sở Củ Chi", "2.180.000đ", "786.700đ", "bảng giá 2025"],
       ["Phụ sản Hà Nội, khu dịch vụ", "4.366.000đ", "không có cột", "20/08/2026"],
       ["Đại học Y Dược TP.HCM, cơ sở 1", "5.900.000đ", "706.000đ", "16/07/2020"],
     ],
   },
   {
     "ten": "Ngôi chỏm, ngôi ngược và sinh đôi ở những nơi công bố đủ",
     "kiem_chung": "chinh-thuc",
     "nguon": "Bệnh viện Phụ sản Trung ương, file danh-muc-gia-dich-vu.pdf, mã TS003, TS004, TS007, file không ghi ngày. Bệnh viện Phụ sản Hà Nội, bảng giá khu thường, đăng 20/08/2026. Bệnh viện Đa khoa Xuyên Á, Bảng giá dịch vụ kỹ thuật 2025, cơ sở Củ Chi, hai cột giá bệnh viện và BHYT chi trả.",
     "cot": ["Nơi và cột giá", "Ngôi chỏm", "Ngôi ngược", "Sinh đôi trở lên"],
     "hang": [
       ["Phụ sản Trung ương", "706.000đ", "1.002.000đ", "1.227.000đ"],
       ["Phụ sản Hà Nội, khu thường", "786.700đ", "1.191.900đ", "1.510.000đ"],
       ["Xuyên Á Củ Chi, giá bệnh viện", "2.180.000đ", "2.000.000đ", "3.330.000đ"],
       ["Xuyên Á Củ Chi, cột BHYT chi trả", "786.700đ", "1.191.900đ", "1.510.300đ"],
     ],
   },
   {
     "ten": "Gói sinh thường đơn thai ở bệnh viện tư và quốc tế, xếp từ thấp lên cao",
     "kiem_chung": "chinh-thuc",
     "nguon": "Bệnh viện Quốc tế City, trang gói sinh Yêu Thương, áp dụng từ 07/03/2025, và trang gói sinh Như Ý, cập nhật 27/02/2026. Bệnh viện Đa khoa Tâm Anh, trang chăm sóc thai sản trọn gói, phần Hà Nội, trang không ghi ngày cập nhật. Bệnh viện Quốc tế Mỹ, các trang gói sinh thường, chúng tôi đọc ngày 13/09/2026, bệnh viện không ghi ngày ban hành. Bệnh viện Việt Pháp Hà Nội, trang Thai sản trọn gói, cập nhật 19/12/2025.",
     "cot": ["Bệnh viện và gói", "Giá", "Bệnh viện ghi gói gồm gì"],
     "hang": [
       ["Quốc tế City, gói Yêu Thương, phòng 2 giường", "<b>17.100.000đ</b>", "chưa gồm phí bác sĩ, thuốc và vật tư"],
       ["Quốc tế City, gói Như Ý", "25.100.000đ", "chỉ ca sinh, chưa gồm tiền phòng"],
       ["Tâm Anh Hà Nội, đăng ký tuần 36, phòng 2 giường", "28.340.000đ", "gói thai sản trọn gói"],
       ["Quốc tế Mỹ, bác sĩ của bệnh viện", "34.600.000đ", "gói sinh thường, lưu viện 02 ngày"],
       ["Việt Pháp Hà Nội, đăng ký khi chuyển dạ", "39.300.000đ", "gói thai sản trọn gói"],
     ],
   },
   {
     "ten": "Gói đơn thai giống nhau, đăng ký sớm thì giá cao hơn",
     "kiem_chung": "chinh-thuc",
     "nguon": "Bệnh viện Việt Pháp Hà Nội, trang Thai sản trọn gói, cập nhật 19/12/2025. Bệnh viện Đa khoa Tâm Anh, trang chăm sóc thai sản trọn gói, phần Hà Nội, phòng 2 giường, trang không ghi ngày cập nhật.",
     "cot": ["Bệnh viện", "Mốc đăng ký", "Giá"],
     "hang": [
       ["Việt Pháp Hà Nội", "tuần 12", "52.800.000đ"],
       ["Việt Pháp Hà Nội", "tuần 22", "46.800.000đ"],
       ["Việt Pháp Hà Nội", "tuần 32", "39.800.000đ"],
       ["Việt Pháp Hà Nội", "khi chuyển dạ", "39.300.000đ"],
       ["Tâm Anh Hà Nội", "tuần 12", "38.140.000đ"],
       ["Tâm Anh Hà Nội", "tuần 36", "28.340.000đ"],
     ],
   },
   {
     "ten": "Hai con số đang lan truyền cho Đại học Y Dược, không tìm được bản gốc",
     "kiem_chung": "chua-xac-minh",
     "nguon": "Bảng do AVAKids đăng, tự ghi cập nhật ngày 04/07/2023, được nhiều trang khác chép lại. Chúng tôi không tìm thấy bảng này trên website của bệnh viện.",
 ...
 "y_chinh": [
   ["Con số 706.000 đồng và con số 17,1 triệu đồng không so được với nhau",
    "706.000 đồng là tiền công của đúng một thủ thuật, tên trong bảng giá là đỡ đẻ thường ngôi chỏm. Nó chưa gồm ngày giường, thuốc, xét nghiệm hay khám cho em bé. 17.100.000 đồng là giá một gói sinh ở bệnh viện tư. Đặt hai con số cạnh nhau rồi kết luận bệnh viện tư đắt gấp 24 lần là so hai thứ khác loại."],
   ["Ở khu thường, giá đỡ đẻ của hai bệnh viện công Hà Nội trùng đúng cột bảo hiểm y tế ở nơi khác",
    "Phụ sản Trung ương ghi 706.000 đồng, đúng bằng cột mức bảo hiểm y tế cùng dòng trong bảng của Đại học Y Dược TP.HCM. Phụ sản Hà Nội khu thường ghi 786.700 đồng, đúng bằng cột bảo hiểm y tế chi trả của Xuyên Á. Ca ngôi ngược cũng trùng, cùng 1.191.900 đồng. Riêng ca sinh đôi lệch nhau 300 đồng, 1.510.000 đồng so với 1.510.300 đồng. Các bảng giá không giải thích vì sao, chúng tôi chỉ đặt các con số cạnh nhau."],
   ["Cùng Phụ sản Hà Nội, khu dịch vụ đắt gấp 5,55 lần khu thường",
    "Một ca đỡ đẻ thường ngôi chỏm là 786.700 đồng ở khu thường và 4.366.000 đồng ở khu dịch vụ, theo bảng bệnh viện đăng ngày 20/08/2026. Cùng một thủ thuật, cùng một bệnh viện, khác nhau ở khu điều trị."],
   ["Phí chọn bác sĩ lớn hơn cả tiền công đỡ đẻ",
    "Cũng bảng đó ghi phí chọn bác sĩ cộng thêm 5.000.000 đồng cho ca đỡ đẻ thường ở khu thường. Con số này gấp 6,36 lần chính tiền công đỡ đẻ. Ở khu dịch vụ, phí chọn bác sĩ là 6.000.000 đồng."],
   ["Ở hai nơi, giá tự trả cho ca ngôi ngược lại thấp hơn ca ngôi chỏm",
    "Xuyên Á ghi đỡ đẻ ngôi ngược 2.000.000 đồng, thấp hơn ngôi chỏm 2.180.000 đồng. Khu dịch vụ Phụ sản Hà Nội cũng vậy: 3.960.000 đồng so với 4.366.000 đồng. Trong khi đó ở ba dòng còn lại của bảng, gồm Phụ sản Trung ương, khu thường Phụ sản Hà Nội và cột bảo hiểm y tế của Xuyên Á, ngôi ngược đều cao hơn ngôi chỏm. Không bệnh viện nào giải thích khoảng lệch này."],
   ["Đăng ký gói càng sớm thì giá càng cao",
    "Gói đơn thai của Việt Pháp Hà Nội là 52.800.000 đồng nếu đăng ký từ tuần 12 và 39.300.000 đồng nếu đăng ký khi chuyển dạ, chênh 13.500.000 đồng. Ở Tâm Anh Hà Nội, phòng 2 giường, tuần 12 là 38.140.000 đồng còn tuần 36 là 28.340.000 đồng, chênh 9.800.000 đồng. Bài này không so nội dung từng mốc gói, nên không nói phần chênh đó mua được thêm những gì."],
   ["Bốn khoản hay nằm ngoài giá gói",
    "Gói Yêu Thương của Quốc tế City ghi rõ chưa gồm phí bác sĩ, thuốc và vật tư. Gói Như Ý chỉ gồm ca sinh, chưa gồm tiền phòng. Hạnh Phúc đặt hạn mức thuốc, dịch truyền và vật tư trong gói sinh thường là 3.000.000 đồng, vượt thì tự trả. Phụ sản Hà Nội tính phí chọn bác sĩ riêng. Đọc giá gói mà không đọc dòng gồm những gì thì dễ hụt tiền khi ra viện."],
   ["Con số 11,5 triệu đồng lan truyền trên mạng chưa chắc cùng loại với con số của bệnh viện",
    "Nhiều trang chép lại bảng ghi sinh thường ngôi chỏm ở Đại học Y Dược là 11.500.000 đồng. Bảng giá bệnh viện đăng theo Quyết định năm 2020 ghi đỡ đẻ thường ngôi chỏm 5.900.000 đồng. Chúng tôi không tìm được bản gốc của con số 11,5 triệu đồng, và không biết nó là tiền công hay giá trọn gói, nên để riêng ở bảng chưa xác minh."],
   ["Ba câu nên hỏi trước khi chọn nơi sinh",
    "Một, con số được báo là tiền công đỡ đẻ hay giá một gói. Hai, nếu là gói thì gói gồm những gì, có tiền phòng, phí bác sĩ, thuốc và vật tư chưa. Ba, gói có hạn mức cho thuốc và vật tư không, và vượt hạn mức thì tính thế nào."],
 ],
 "khong_ro": [
   "File giá của Phụ sản Trung ương không ghi ngày ban hành và không ghi số quyết định. Chúng tôi dùng con số trong file nhưng không biết nó áp dụng từ khi nào.",
   "Bảng giá của Đại học Y Dược TP.HCM theo Quyết định 1364/QĐ-ĐHYD ngày 16/07/2020. Chúng tôi không biết bệnh viện đã có bản mới hơn hay chưa.",
   "Phụ sản MêKông ghi dòng Sanh thường 7.500.000 đồng trong bảng giá cập nhật ngày 03/06/2022, nhưng không nói đó là tiền công hay giá gói, nên chúng tôi chưa đưa vào bảng.",
   "Trang gói thai sản của Tâm Anh không ghi ngày cập nhật.",
   "Số tham khảo cho Vinmec chỉ có từ các trang bên thứ ba, bệnh viện chưa xác nhận, nên không đưa vào bài này.",
 ],
 "faq": [
   ["Đẻ thường ở bệnh viện công hết bao nhiêu tiền?",
    "Tiền công đỡ đẻ thường ngôi chỏm trong dữ liệu của chúng tôi từ 706.000 đồng ở Phụ sản Trung ương tới 4.366.000 đồng ở khu dịch vụ Phụ sản Hà Nội. Đó chỉ là tiền công thủ thuật, chưa gồm ngày giường, thuốc và các khoản khác."],
   ["Gói sanh thường ở bệnh viện tư rẻ nhất bao nhiêu?",
    "17.100.000 đồng, gói Yêu Thương của Bệnh viện Quốc tế City, phòng 2 giường. Bệnh viện ghi rõ gói này chưa gồm phí bác sĩ, thuốc và vật tư."],
   ["Vì sao cùng một bệnh viện mà có hai mức giá đỡ đẻ?",
    "Phụ sản Hà Nội tách khu thường và khu dịch vụ. Ca đỡ đẻ thường ngôi chỏm là 786.700 đồng ở khu thường và 4.366.000 đồng ở khu dịch vụ."],
   ["Đăng ký gói sinh sớm có rẻ hơn không?",
    "Ở hai bệnh viện công bố đủ các mốc là Việt Pháp Hà Nội và Tâm Anh Hà Nội thì ngược lại: đăng ký sớm có giá cao hơn đăng ký muộn."],
 ],
 "lien_quan": ["sinh-mo-ton-bao-nhieu", "phi-chon-bac-si-do-sinh", "goi-sinh-tron-goi-khong-bao-gom-gi"],
},

{
 "slug": "nghi-thai-san-duoc-bao-lau-huong-bao-nhieu",
 "cum": "E",
 "ngay_dang": "2026-09-24",
 "tag": "Bảo vệ thu nhập",
 "doc": "7 phút đọc",
 "title": "Nghỉ thai sản được bao lâu, hưởng bao nhiêu: 06 tháng cho mẹ, 05 tới 14 ngày làm việc cho bố",
 "h1": "Nghỉ thai sản được bao lâu và được trả bao nhiêu",
 "desc": "Lao động nữ sinh con được nghỉ 06 tháng, hưởng 100% bình quân tiền lương đóng bảo hiểm xã hội của 06 tháng gần nhất. Lao động nam được nghỉ 05 tới 14 ngày làm việc tuỳ trường hợp.",
 "tom_tat": "Lao động nữ sinh con được nghỉ <b>06 tháng</b>, trong đó phần nghỉ trước sinh không quá 02 tháng; sinh đôi trở lên thì mỗi con thêm 01 tháng. Tiền hưởng mỗi tháng bằng <b>100%</b> mức bình quân tiền lương làm căn cứ đóng bảo hiểm xã hội bắt buộc của 06 tháng gần nhất. Kèm theo là khoản trợ cấp một lần bằng <b>02 lần mức tham chiếu</b> cho mỗi con. Lao động nam được nghỉ từ <b>05 tới 14 ngày làm việc</b> khi vợ sinh. Các con số trong bài đều gắn với bảo hiểm xã hội bắt buộc.",
 "bang": [
   {
     "ten": "Năm quy định về thai sản khi sinh con, theo bài hướng dẫn của Bảo hiểm xã hội Việt Nam",
     "kiem_chung": "thu-cap",
     "nguon": "Bài Chế độ thai sản trong Luật Bảo hiểm xã hội năm 2024 trên baohiemxahoi.gov.vn, đăng 07/07/2025. Nhãn thứ cấp vì đây là bài hướng dẫn của cơ quan bảo hiểm xã hội, không phải văn bản luật; bài chỉ nêu số điều cho hai dòng đầu.",
     "cot": ["Nội dung", "Nguyên văn trong bài", "Căn cứ bài nêu"],
     "hang": [
       ["Thời gian mẹ nghỉ", "&ldquo;Lao động nữ được nghỉ thai sản trước và sau khi sinh con là <b>06 tháng</b>; thời gian nghỉ trước khi sinh không quá 02 tháng&rdquo;", "Điều 139 Bộ luật Lao động"],
       ["Sinh đôi trở lên", "&ldquo;cứ mỗi con, người mẹ được nghỉ thêm 01 tháng&rdquo;", "Điều 139 Bộ luật Lao động"],
       ["Mức hưởng hằng tháng", "&ldquo;Mức hưởng bằng 100% mức bình quân tiền lương làm căn cứ đóng BHXH bắt buộc của 06 tháng gần nhất trước khi nghỉ việc&rdquo;", "bài không nêu số điều"],
       ["Trợ cấp một lần", "&ldquo;Mức hưởng bằng 02 lần mức tham chiếu tại tháng lao động nữ sinh con&hellip; tính cho mỗi con&rdquo;", "bài không nêu số điều"],
       ["Điều kiện đóng", "&ldquo;Phải đóng BHXH bắt buộc từ đủ 06 tháng trở lên trong thời gian 12 tháng liền kề trước khi sinh con&rdquo;", "bài không nêu số điều"],
     ],
   },
   {
     "ten": "Số ngày làm việc lao động nam được nghỉ khi vợ sinh con",
     "kiem_chung": "thu-cap",
     "nguon": "Bài của Bảo hiểm xã hội Việt Nam trên baohiemxahoi.gov.vn, đăng 07/07/2025, đối chiếu với bài trình bày Điều 53 Luật Bảo hiểm xã hội số 41/2024/QH15 trên Cổng Xây dựng chính sách ngày 29/07/2024. Hai bài cho cùng các con số, nhưng không bài nào trích nguyên văn điều luật.",
     "cot": ["Trường hợp", "Số ngày làm việc"],
     "hang": [
       ["Vợ sinh thường một con", "<b>05</b>"],
       ["Vợ sinh phải phẫu thuật, hoặc sinh con dưới 32 tuần tuổi", "07"],
       ["Vợ sinh đôi", "10"],
       ["Vợ sinh đôi phải phẫu thuật", "14"],
       ["Từ con thứ ba trở đi", "cộng thêm 03 cho mỗi con"],
     ],
   },
   {
     "ten": "Điều 7 Luật Bảo hiểm xã hội về mức tham chiếu, ba khoản",
     "kiem_chung": "chinh-thuc",
     "nguon": "Luật Bảo hiểm xã hội số 41/2024/QH15, Điều 7, trích nguyên văn từ bản toàn văn trên Cổng Xây dựng chính sách.",
     "cot": ["Khoản", "Nguyên văn"],
     "hang": [
       ["1", "&ldquo;Mức tham chiếu là mức tiền do Chính phủ quyết định dùng để tính mức đóng, mức hưởng một số chế độ bảo hiểm xã hội quy định trong Luật này.&rdquo;"],
       ["2", "&ldquo;Mức tham chiếu được điều chỉnh trên cơ sở mức tăng của chỉ số giá tiêu dùng, tăng trưởng kinh tế, phù hợp với khả năng của ngân sách nhà nước và quỹ bảo hiểm xã hội.&rdquo;"],
       ["3", "&ldquo;Chính phủ quy định chi tiết Điều này.&rdquo;"],
     ],
   },
 ],
 "y_chinh": [
   ["Sáu tháng là tổng, và phần trước sinh bị chặn ở hai tháng",
    "Bài hướng dẫn của Bảo hiểm xã hội Việt Nam dẫn Điều 139 Bộ luật Lao động: lao động nữ được nghỉ trước và sau khi sinh con là 06 tháng, phần nghỉ trước khi sinh không quá 02 tháng. Nghĩa là ít nhất bốn tháng rơi vào sau khi sinh. Sinh đôi trở lên thì tính từ con thứ hai, mỗi con thêm 01 tháng."],
   ["Tiền hưởng lấy bình quân sáu tháng, không lấy tháng lương cuối",
    "Mức hưởng bằng 100% mức bình quân tiền lương làm căn cứ đóng bảo hiểm xã hội bắt buộc của 06 tháng gần nhất trước khi nghỉ việc. Một lần tăng lương ngay trước khi nghỉ chỉ vào con số bình quân theo số tháng đã đóng ở mức mới, chứ không kéo cả sáu tháng lên theo."],
   ["Căn cứ là tiền lương đóng bảo hiểm, không phải tổng thu nhập",
    "Câu chữ ghi rõ &ldquo;tiền lương làm căn cứ đóng BHXH bắt buộc&rdquo;. Nếu tiền lương đóng bảo hiểm xã hội thấp hơn thu nhập thực nhận, thì tiền thai sản đi theo con số đóng bảo hiểm. Người sắp sinh nên xem lại mức lương ghi trên sổ bảo hiểm xã hội của mình."],
   ["Trợ cấp một lần tính theo mức tham chiếu, và luật giao Chính phủ quyết định con số đó",
    "Mỗi con được trợ cấp một lần bằng 02 lần mức tham chiếu. Điều 7 Luật Bảo hiểm xã hội số 41/2024/QH15 chỉ định nghĩa mức tham chiếu là mức tiền do Chính phủ quyết định, không ghi con số. Bài của Bảo hiểm xã hội Việt Nam đăng ngày 07/07/2025 chú thích rằng mức tham chiếu khi đó bằng lương cơ sở. Lương cơ sở đã đổi thành 2.530.000 đồng từ 01/07/2026, nhưng chúng tôi chưa đọc được văn bản nào nói mức tham chiếu đổi theo, nên không quy ra số tiền."],
   ["Bố được nghỉ từ năm tới mười bốn ngày làm việc",
    "Vợ sinh thường một con thì chồng nghỉ 05 ngày làm việc. Vợ sinh phải phẫu thuật hoặc sinh con dưới 32 tuần tuổi thì 07 ngày. Sinh đôi thì 10 ngày, sinh đôi phải phẫu thuật thì 14 ngày. Từ con thứ ba trở đi, mỗi con cộng thêm 03 ngày làm việc. Tính theo ngày làm việc, nên cuối tuần không bị trừ vào số ngày này."],
   ["Điều kiện cơ bản là đóng đủ sáu trong mười hai tháng",
    "Lao động nữ sinh con phải đóng bảo hiểm xã hội bắt buộc từ đủ 06 tháng trở lên trong 12 tháng liền kề trước khi sinh. Người mới đi làm, hoặc nghỉ việc một thời gian trước khi sinh, nên đếm lại số tháng đã đóng trong cửa sổ mười hai tháng đó."],
   ["Các con số trong bài đều gắn với bảo hiểm xã hội bắt buộc",
    "Cả năm quy định ở bảng đầu đều nói tới bảo hiểm xã hội bắt buộc. Người làm tự do, chủ hộ kinh doanh hay người không có hợp đồng lao động không nằm trong phạm vi các con số này. Với họ, khoản thu nhập bị hụt trong những tháng sinh con phải tính bằng nguồn khác."],
 ],
 "khong_ro": [
   "Chúng tôi chưa đọc được nguyên văn các điều về chế độ thai sản trong Luật Bảo hiểm xã hội số 41/2024/QH15. Bản toàn văn trên Cổng Xây dựng chính sách chỉ đọc được tới chương IV, nên các con số trong bài lấy từ bài hướng dẫn của Bảo hiểm xã hội Việt Nam và gắn nhãn thứ cấp.",
   "Bài của Bảo hiểm xã hội Việt Nam nêu một điều kiện riêng cho trường hợp mang thai từ 22 tuần tuổi phải nghỉ dưỡng thai, nhưng đoạn chúng tôi đọc được không đủ để chép trọn, nên bài này không đưa vào.",
   "Chúng tôi chưa có văn bản nào cho biết mức tham chiếu hiện bằng bao nhiêu đồng sau ngày 01/07/2026, nên không quy trợ cấp một lần ra tiền.",
   "Bài này không nói tới chế độ thai sản cho người tham gia bảo hiểm xã hội tự nguyện.",
 ],
 "faq": [
   ["Nghỉ thai sản được bao lâu?",
    "Lao động nữ sinh con được nghỉ 06 tháng, phần nghỉ trước khi sinh không quá 02 tháng. Sinh đôi trở lên thì từ con thứ hai, mỗi con thêm 01 tháng."],
   ["Chồng được nghỉ mấy ngày khi vợ sinh?",
    "Từ 05 tới 14 ngày làm việc tuỳ trường hợp: 05 ngày khi vợ sinh thường, 07 ngày khi vợ phải phẫu thuật hoặc sinh con dưới 32 tuần tuổi, 10 ngày khi sinh đôi, 14 ngày khi sinh đôi phải phẫu thuật."],
   ["Tiền thai sản mỗi tháng được bao nhiêu?",
    "Bằng 100% mức bình quân tiền lương làm căn cứ đóng bảo hiểm xã hội bắt buộc của 06 tháng gần nhất trước khi nghỉ việc."],
   ["Trợ cấp một lần khi sinh con là bao nhiêu tiền?",
    "Bằng 02 lần mức tham chiếu cho mỗi con. Luật giao Chính phủ quyết định mức tham chiếu, và chúng tôi chưa có văn bản cho biết con số hiện hành sau ngày 01/07/2026."],
 ],
 "lien_quan": ["sinh-thuong-ton-bao-nhieu", "nghi-om-dai-ngay-bhxh-tra-bao-nhieu", "luong-co-so-moi-doi-gi-trong-bhyt"],
},

{
 "slug": "sinh-doi-ton-bao-nhieu",
 "cum": "A",
 "ngay_dang": "2026-09-25",
 "tag": "Thai sản",
 "doc": "7 phút đọc",
 "title": "Sinh đôi hết bao nhiêu tiền: bảy bệnh viện, phần đắt thêm so với một con từ 521.000 đồng tới 14,1 triệu đồng",
 "h1": "Sinh đôi tốn thêm bao nhiêu tiền so với sinh một con",
 "desc": "Bảy bệnh viện công bố giá cho cả đơn thai và song thai. Ở tiền công đỡ đẻ và mổ, song thai đắt gấp 1,5 tới 1,92 lần. Ở giá gói bệnh viện tư, phần thêm từ 2 triệu tới 14,1 triệu đồng.",
 "tom_tat": "Chúng tôi tìm trong biểu giá của 21 bệnh viện những nơi ghi cả giá đơn thai lẫn giá song thai cho cùng một cách sinh, và được <b>bảy bệnh viện</b>. Ở bảng tiền công thủ thuật của bệnh viện công, ca sinh đôi đắt gấp 1,5 tới 1,92 lần ca một con. Ở giá gói của bệnh viện tư, phần đắt thêm từ <b>2.000.000 đồng</b> ở An Sinh tới <b>14.100.000 đồng</b> ở Quốc tế Mỹ. Ngoài giá sinh, vài khoản nhỏ như theo dõi tim thai và tạm ứng nhập viện cũng tính mức riêng cho song thai.",
 "bang": [
   {
     "ten": "Đơn thai và song thai đặt cạnh nhau ở cùng bệnh viện, cùng cách sinh",
     "kiem_chung": "chinh-thuc",
     "nguon": "Bệnh viện Phụ sản Trung ương, file danh-muc-gia-dich-vu.pdf, mã TS003 và TS007, file không ghi ngày. Bệnh viện Phụ sản Hà Nội, bảng giá khu thường, đăng 20/08/2026. Bệnh viện Đa khoa Xuyên Á, Bảng giá dịch vụ kỹ thuật 2025, cơ sở Củ Chi. Bệnh viện An Sinh, trang Gói khám thai sản, cập nhật 03/03/2026, cột giá ưu đãi trọn gói. Bệnh viện Đa khoa Tâm Anh, trang chăm sóc thai sản trọn gói, phần Hà Nội, trang không ghi ngày cập nhật. Bệnh viện Việt Pháp Hà Nội, trang Thai sản trọn gói, cập nhật 19/12/2025. Bệnh viện Quốc tế Mỹ, các trang gói sinh thường, đọc ngày 13/09/2026. Cột phần đắt thêm là phép trừ của chúng tôi.",
     "cot": ["Bệnh viện và dịch vụ", "Đơn thai", "Song thai", "Phần đắt thêm"],
     "hang": [
       ["Phụ sản Trung ương, tiền công đỡ đẻ", "706.000đ", "1.227.000đ", "<b>521.000đ</b>"],
       ["Phụ sản Hà Nội khu thường, tiền công đỡ đẻ", "786.700đ", "1.510.000đ", "723.300đ"],
       ["Xuyên Á Củ Chi, tiền công đỡ đẻ", "2.180.000đ", "3.330.000đ", "1.150.000đ"],
       ["Xuyên Á Củ Chi, phẫu thuật lấy thai lần đầu", "4.360.000đ", "6.540.000đ", "2.180.000đ"],
       ["An Sinh, gói sanh mổ lần 1", "28.000.000đ", "30.000.000đ", "2.000.000đ"],
       ["An Sinh, gói sanh mổ lần 2", "31.000.000đ", "33.000.000đ", "2.000.000đ"],
       ["An Sinh, gói sanh mổ lần 3", "34.000.000đ", "36.000.000đ", "2.000.000đ"],
       ["Tâm Anh Hà Nội, sinh thường tuần 12, phòng 2 giường", "38.140.000đ", "48.570.000đ", "10.430.000đ"],
       ["Tâm Anh Hà Nội, sinh thường tuần 12, phòng 1 giường", "43.080.000đ", "54.670.000đ", "11.590.000đ"],
       ["Việt Pháp Hà Nội, sinh thường đăng ký tuần 12", "52.800.000đ", "62.800.000đ", "10.000.000đ"],
       ["Việt Pháp Hà Nội, sinh mổ đăng ký tuần 12", "68.800.000đ", "78.200.000đ", "9.400.000đ"],
       ["Quốc tế Mỹ, sinh thường, bác sĩ của bệnh viện", "34.600.000đ", "48.700.000đ", "<b>14.100.000đ</b>"],
     ],
   },
   {
     "ten": "Cột bảo hiểm y tế ở Xuyên Á: tăng cho ca đỡ đẻ song thai, đứng yên cho ca mổ",
     "kiem_chung": "chinh-thuc",
     "nguon": "Bệnh viện Đa khoa Xuyên Á, Bảng giá dịch vụ kỹ thuật 2025, cơ sở Củ Chi, hai cột giá bệnh viện và BHYT chi trả.",
     "cot": ["Dịch vụ", "Giá bệnh viện", "BHYT chi trả"],
     "hang": [
       ["Đỡ đẻ thường ngôi chỏm", "2.180.000đ", "786.700đ"],
       ["Đỡ đẻ từ sinh đôi trở lên", "3.330.000đ", "1.510.300đ"],
       ["Phẫu thuật lấy thai lần đầu", "4.360.000đ", "2.604.800đ"],
       ["Phẫu thuật lấy thai lần đầu, song thai", "6.540.000đ", "2.604.800đ"],
     ],
   },
   {
     "ten": "Các khoản nhỏ cũng tính mức riêng cho song thai",
     "kiem_chung": "chinh-thuc",
     "nguon": "Bệnh viện Phụ sản Hà Nội, bảng giá dịch vụ khám sản và phụ khoa cơ bản đăng 22/05/2026, bảng giá sinh đăng 20/08/2026. Bệnh viện Phụ sản Trung ương, Quyết định 2312/QĐ-PSTW ngày 30/07/2026, phí dịch vụ theo yêu cầu cơ sở 2.",
     "cot": ["Bệnh viện", "Khoản", "Đơn thai", "Song thai"],
     "hang": [
       ["Phụ sản Hà Nội", "Monitor sản khoa", "180.000đ", "280.000đ"],
       ["Phụ sản Trung ương", "Monitor sản khoa, phí theo yêu cầu", "180.000đ", "280.000đ"],
       ["Phụ sản Hà Nội", "Siêu âm 3D/4D", "500.000đ", "550.000đ"],
       ["Phụ sản Hà Nội, khu thường", "Phí chọn bác sĩ đỡ đẻ, cộng thêm", "5.000.000đ", "6.000.000đ"],
       ["Phụ sản Hà Nội, khu thường", "Tạm ứng khi nhập viện", "15.000.000đ", "20.000.000đ với mổ đẻ đa thai"],
     ],
   },
   {
     "ten": "Một con số đang lan truyền cho Đại học Y Dược, không tìm được bản gốc",
     "kiem_chung": "chua-xac-minh",
     "nguon": "Bảng do AVAKids đăng, tự ghi cập nhật ngày 04/07/2023, được nhiều trang khác chép lại. Chúng tôi không tìm thấy bảng này trên website của bệnh viện.",
     "cot": ["Hình thức sinh", "Số bên thứ ba đưa ra"],
     "hang": [
 ...
 "y_chinh": [
   ["Ở bảng tiền công, sinh đôi đắt gấp rưỡi tới gần gấp đôi",
    "Ca đỡ đẻ sinh đôi đắt gấp 1,74 lần ca một con ở Phụ sản Trung ương, gấp 1,92 lần ở khu thường Phụ sản Hà Nội và gấp 1,53 lần ở Xuyên Á. Ca mổ lấy thai lần đầu ở Xuyên Á đắt gấp đúng 1,5 lần khi là song thai. Các tỷ lệ này là phép chia của chúng tôi trên số bệnh viện đăng."],
   ["Ở giá gói bệnh viện tư, phần đắt thêm chỉ từ 6% tới 41%",
    "An Sinh cộng đúng 2.000.000 đồng cho song thai ở cả ba mức sanh mổ lần 1, lần 2 và lần 3, tức từ khoảng 6% tới 7% giá gói đơn thai. Việt Pháp Hà Nội cộng 10.000.000 đồng cho sinh thường và 9.400.000 đồng cho sinh mổ. Quốc tế Mỹ cộng nhiều nhất, 14.100.000 đồng, tức 41%. Giá gói đã gồm nhiều khoản cố định như phòng và khám, nên phần song thai chỉ đội lên một phần."],
   ["Ở Xuyên Á, cột bảo hiểm y tế không tăng cho ca mổ song thai",
    "Ca đỡ đẻ sinh đôi có cột bảo hiểm y tế 1.510.300 đồng, gần gấp đôi ca một con 786.700 đồng. Nhưng ca mổ lấy thai lần đầu thì cột bảo hiểm y tế giữ nguyên 2.604.800 đồng dù là đơn thai hay song thai, trong khi giá bệnh viện tăng thêm 2.180.000 đồng. Phần tăng đó rơi hết vào tiền tự trả. Bảng giá không giải thích vì sao."],
   ["Ba thai: chỉ Tâm Anh Hà Nội công bố",
    "Gói sinh thường đăng ký tuần 12 cho ba thai ở Tâm Anh Hà Nội là 57.750.000 đồng với phòng 2 giường và 64.870.000 đồng với phòng 1 giường. Từ hai thai lên ba thai cộng thêm 9.180.000 đồng với phòng 2 giường và 10.200.000 đồng với phòng 1 giường, gần bằng mức cộng từ một lên hai thai là 10.430.000 đồng và 11.590.000 đồng."],
   ["Có nơi đưa song thai ra khỏi gói tiêu chuẩn",
    "Hoàn Mỹ Sài Gòn ghi sinh song thai trong danh sách khoản gói không bao gồm, theo trang gói thai sản cập nhật ngày 11/12/2025. Nghĩa là người mang song thai không dùng được giá gói tiêu chuẩn ở đây, mà phải hỏi giá riêng."],
   ["Tiền giữ chỗ khi nhập viện cũng cao hơn",
    "Khu thường Phụ sản Hà Nội thu tạm ứng 15.000.000 đồng cho ca đẻ thường và mổ lấy thai, nhưng 20.000.000 đồng cho mổ đẻ đa thai. Đây là tiền tạm ứng, quyết toán theo thực tế, không phải giá cuối."],
   ["Nghỉ thai sản cũng dài hơn khi sinh đôi",
    "Theo bài hướng dẫn của Bảo hiểm xã hội Việt Nam, sinh đôi trở lên thì từ con thứ hai, mỗi con người mẹ được nghỉ thêm 01 tháng. Người chồng được nghỉ 10 ngày làm việc khi vợ sinh đôi, 14 ngày nếu phải phẫu thuật. Chi tiết ở bài về chế độ nghỉ thai sản."],
   ["Ba câu nên hỏi khi biết mang song thai",
    "Một, bệnh viện có gói riêng cho song thai không, hay song thai nằm ngoài gói tiêu chuẩn. Hai, nếu có gói thì phần cộng thêm là bao nhiêu và gồm những gì. Ba, các khoản nhỏ như monitor, siêu âm và tạm ứng có tính mức riêng cho song thai không."],
 ],
 "khong_ro": [
   "Mười bốn bệnh viện còn lại không ghi giá song thai tách riêng, hoặc chỉ ghi giá đơn thai. Chúng tôi không suy giá song thai cho những nơi đó.",
   "File giá của Phụ sản Trung ương không ghi ngày ban hành và không ghi số quyết định. Trang gói thai sản của Tâm Anh không ghi ngày cập nhật.",
   "Các bệnh viện không nói gói song thai khác gói đơn thai ở những khoản nào, nên bài này chỉ so con số tổng.",
   "Con số 14.400.000 đồng cho Đại học Y Dược chỉ có trên trang của bên thứ ba và không nói rõ là tiền công hay giá trọn gói.",
 ],
 "faq": [
   ["Sinh đôi đắt hơn sinh một con bao nhiêu?",
    "Trong bảy bệnh viện công bố đủ hai mức, phần đắt thêm từ 521.000 đồng ở tiền công đỡ đẻ của Phụ sản Trung ương tới 14.100.000 đồng ở gói sinh thường của Quốc tế Mỹ."],
   ["Gói sinh song thai ở bệnh viện tư rẻ nhất là bao nhiêu?",
    "Trong dữ liệu của chúng tôi, gói sanh mổ lần 1 song thai của An Sinh là 30.000.000 đồng theo giá ưu đãi, đắt hơn gói đơn thai tương ứng 2.000.000 đồng."],
   ["Bảo hiểm y tế có trả thêm cho ca mổ song thai không?",
    "Ở bảng giá Xuyên Á thì không: cột bảo hiểm y tế cho phẫu thuật lấy thai lần đầu là 2.604.800 đồng cho cả đơn thai và song thai. Riêng ca đỡ đẻ thì cột bảo hiểm y tế có tăng cho sinh đôi."],
   ["Sinh đôi thì được nghỉ thai sản bao lâu?",
    "Từ con thứ hai, mỗi con người mẹ được nghỉ thêm 01 tháng. Người chồng được nghỉ 10 ngày làm việc, 14 ngày nếu vợ phải phẫu thuật."],
 ],
 "lien_quan": ["sinh-thuong-ton-bao-nhieu", "sinh-mo-ton-bao-nhieu", "nghi-thai-san-duoc-bao-lau-huong-bao-nhieu"],
},

{
 "slug": "bao-hiem-tra-tien-trong-bao-nhieu-ngay",
 "cum": "C",
 "ngay_dang": "2026-09-25",
 "tag": "Bồi thường",
 "doc": "6 phút đọc",
 "title": "Bảo hiểm phải trả tiền trong bao nhiêu ngày: 15 ngày chỉ là mức mặc định, và phải đủ hồ sơ hợp lệ mới bắt đầu đếm",
 "h1": "Công ty bảo hiểm phải trả tiền trong bao nhiêu ngày",
 "desc": "Điều 31 Luật Kinh doanh bảo hiểm cho hợp đồng tự thoả thuận thời hạn trả tiền. Chỉ khi hợp đồng không ghi thì mới áp mốc 15 ngày, đếm từ ngày nhận đủ hồ sơ hợp lệ. Chậm trả thì phải trả lãi.",
 "tom_tat": "Nhiều người nghe rằng công ty bảo hiểm phải trả tiền trong <b>15 ngày</b>. Điều 31 Luật Kinh doanh bảo hiểm số 08/2022/QH15 nói khác một chút: doanh nghiệp trả <b>theo thời hạn đã thoả thuận trong hợp đồng</b>, và chỉ khi hợp đồng không thoả thuận thì mới áp mốc 15 ngày. Mốc đó đếm từ ngày doanh nghiệp nhận được <b>đầy đủ hồ sơ hợp lệ</b>, không phải từ ngày nộp. Trả chậm thì phải trả lãi cho số tiền chậm trả. Phía người mua có <b>01 năm</b> để nộp hồ sơ, theo Điều 30.",
 "bang": [
   {
     "ten": "Điều 31, hai khoản về thời hạn trả tiền",
     "kiem_chung": "chinh-thuc",
     "nguon": "Luật Kinh doanh bảo hiểm số 08/2022/QH15, hiệu lực 01/01/2023, Điều 31, trích nguyên văn từ bản toàn văn trên Cổng Xây dựng chính sách.",
     "cot": ["Khoản", "Nguyên văn"],
     "hang": [
       ["1", "&ldquo;Khi xảy ra sự kiện bảo hiểm, doanh nghiệp bảo hiểm, chi nhánh doanh nghiệp bảo hiểm phi nhân thọ nước ngoài phải bồi thường, trả tiền bảo hiểm theo thời hạn đã thỏa thuận trong hợp đồng bảo hiểm. Trường hợp không có thỏa thuận về thời hạn thì doanh nghiệp bảo hiểm, chi nhánh doanh nghiệp bảo hiểm phi nhân thọ nước ngoài phải bồi thường, trả tiền bảo hiểm trong thời hạn <b>15 ngày</b> kể từ ngày nhận được đầy đủ hồ sơ hợp lệ về yêu cầu bồi thường, trả tiền bảo hiểm.&rdquo;"],
       ["2", "&ldquo;Trường hợp doanh nghiệp bảo hiểm, chi nhánh doanh nghiệp bảo hiểm phi nhân thọ nước ngoài chậm bồi thường, trả tiền bảo hiểm theo quy định tại khoản 1 Điều này thì phải trả lãi đối với số tiền chậm trả tương ứng với thời gian chậm trả. Lãi suất đối với số tiền chậm trả được xác định theo thỏa thuận của các bên theo quy định của Bộ luật Dân sự.&rdquo;"],
     ],
   },
   {
     "ten": "Điều 30, ba khoản về thời hạn nộp hồ sơ",
     "kiem_chung": "chinh-thuc",
     "nguon": "Luật Kinh doanh bảo hiểm số 08/2022/QH15, Điều 30, trích nguyên văn từ bản toàn văn trên Cổng Xây dựng chính sách.",
     "cot": ["Khoản", "Nguyên văn"],
     "hang": [
       ["1", "&ldquo;Thời hạn nộp hồ sơ yêu cầu bồi thường, trả tiền bảo hiểm theo hợp đồng bảo hiểm là <b>01 năm</b> kể từ ngày xảy ra sự kiện bảo hiểm. Thời gian xảy ra sự kiện bất khả kháng hoặc trở ngại khách quan không tính vào thời hạn nộp hồ sơ yêu cầu bồi thường, trả tiền bảo hiểm.&rdquo;"],
       ["2", "&ldquo;Trường hợp người được bảo hiểm hoặc người thụ hưởng chứng minh được rằng không biết thời điểm xảy ra sự kiện bảo hiểm thì thời hạn quy định tại khoản 1 Điều này được tính từ ngày người được bảo hiểm hoặc người thụ hưởng biết việc xảy ra sự kiện bảo hiểm đó.&rdquo;"],
       ["3", "&ldquo;Trường hợp người thứ ba yêu cầu bên mua bảo hiểm bồi thường về những thiệt hại thuộc trách nhiệm bảo hiểm theo thoả thuận trong hợp đồng bảo hiểm thì thời hạn quy định tại khoản 1 Điều này được tính từ ngày người thứ ba yêu cầu.&rdquo;"],
     ],
   },
   {
     "ten": "Ba mốc thời gian và ngày bắt đầu đếm của từng mốc",
     "kiem_chung": "chinh-thuc",
     "nguon": "Tổng hợp từ Điều 30 và Điều 31 Luật Kinh doanh bảo hiểm số 08/2022/QH15.",
     "cot": ["Việc", "Thời hạn", "Bắt đầu đếm từ"],
     "hang": [
       ["Người mua nộp hồ sơ", "01 năm", "ngày xảy ra sự kiện bảo hiểm, hoặc ngày biết sự kiện nếu chứng minh được trước đó không biết"],
       ["Doanh nghiệp trả tiền", "theo hợp đồng; hợp đồng không ghi thì 15 ngày", "ngày doanh nghiệp nhận được đầy đủ hồ sơ hợp lệ"],
       ["Doanh nghiệp trả chậm", "phải trả lãi cho số tiền chậm trả", "tương ứng với thời gian chậm trả"],
     ],
   },
 ],
 "y_chinh": [
   ["Mười lăm ngày chỉ áp dụng khi hợp đồng không ghi thời hạn",
    "Câu đầu khoản 1 Điều 31 cho doanh nghiệp trả tiền theo thời hạn đã thoả thuận trong hợp đồng. Mốc 15 ngày nằm ở câu sau, bắt đầu bằng chữ &ldquo;Trường hợp không có thỏa thuận về thời hạn&rdquo;. Nghĩa là nơi đầu tiên cần mở là quy tắc, điều khoản của chính hợp đồng mình, chứ không phải con số 15 ngày nghe kể lại."],
   ["Mốc đếm là ngày nhận đủ hồ sơ hợp lệ, không phải ngày nộp",
    "Luật đếm 15 ngày từ ngày doanh nghiệp nhận được đầy đủ hồ sơ hợp lệ. Nếu doanh nghiệp yêu cầu bổ sung giấy tờ, thì hồ sơ lúc nộp lần đầu chưa đầy đủ, và đồng hồ 15 ngày chưa chạy. Giấy biên nhận ghi ngày doanh nghiệp xác nhận đã đủ hồ sơ cho biết mốc đếm thật."],
   ["Trả chậm thì phải trả lãi, nhưng luật không ghi mức lãi",
    "Khoản 2 Điều 31 buộc doanh nghiệp trả lãi cho số tiền chậm trả, tương ứng với thời gian chậm. Lãi suất xác định theo thoả thuận của các bên, theo quy định của Bộ luật Dân sự. Luật Kinh doanh bảo hiểm không tự ghi một con số phần trăm nào."],
   ["Phía người mua có một năm, và thời gian bất khả kháng không bị trừ",
    "Khoản 1 Điều 30 cho người mua 01 năm kể từ ngày xảy ra sự kiện bảo hiểm để nộp hồ sơ. Thời gian xảy ra sự kiện bất khả kháng hoặc trở ngại khách quan không tính vào một năm đó. Người nằm viện dài ngày hoặc gặp tình huống không thể đi lại nên giữ giấy tờ chứng minh khoảng thời gian ấy."],
   ["Không biết sự kiện đã xảy ra thì đếm từ ngày biết",
    "Khoản 2 Điều 30 dời mốc một năm sang ngày người được bảo hiểm hoặc người thụ hưởng biết việc xảy ra sự kiện, với điều kiện chứng minh được rằng trước đó không biết. Trường hợp hay gặp là người thụ hưởng chỉ biết người thân có hợp đồng bảo hiểm sau khi người đó mất."],
   ["Một năm nộp hồ sơ khác với thời hạn khởi kiện",
    "Điều 30 chỉ nói về thời hạn nộp hồ sơ cho doanh nghiệp bảo hiểm. Thời hạn khởi kiện ra toà về hợp đồng bảo hiểm là chuyện khác, quy định ở Bộ luật Dân sự. Bài về hồ sơ bị từ chối bồi thường có bảng đặt hai mốc này cạnh nhau."],
   ["Ba việc nên làm khi nộp hồ sơ",
    "Một, đọc mục thời hạn giải quyết quyền lợi trong quy tắc điều khoản của hợp đồng trước khi nộp. Hai, xin giấy biên nhận hoặc thư xác nhận ghi rõ ngày doanh nghiệp nhận đủ hồ sơ hợp lệ. Ba, ghi lại ngày xảy ra sự kiện bảo hiểm, vì mốc một năm đếm từ ngày đó."],
 ],
 "khong_ro": [
   "Luật dẫn lãi suất chậm trả sang Bộ luật Dân sự nhưng không nói điều nào. Chúng tôi chưa đọc được nguyên văn điều về lãi chậm trả trong Bộ luật Dân sự, nên không nêu con số phần trăm.",
   "Luật không định nghĩa hồ sơ hợp lệ gồm những giấy tờ gì. Danh mục giấy tờ do từng hợp đồng quy định.",
   "Luật số 139/2025/QH15, hiệu lực 01/01/2026, sửa một số điều của Luật Kinh doanh bảo hiểm. Các bài giới thiệu chúng tôi đọc không nhắc tới Điều 30 và Điều 31, nhưng chúng tôi chưa đối chiếu toàn văn luật sửa.",
   "Chúng tôi không có số liệu về thời gian trả tiền thực tế của bất kỳ doanh nghiệp bảo hiểm nào.",
 ],
 "faq": [
   ["Công ty bảo hiểm phải trả tiền trong bao nhiêu ngày?",
    "Theo thời hạn thoả thuận trong hợp đồng. Nếu hợp đồng không thoả thuận thời hạn thì trong 15 ngày kể từ ngày doanh nghiệp nhận được đầy đủ hồ sơ hợp lệ, theo khoản 1 Điều 31 Luật Kinh doanh bảo hiểm số 08/2022/QH15."],
   ["Quá 15 ngày mà chưa được trả thì sao?",
    "Trước hết cần kiểm hợp đồng có ghi thời hạn khác không, và hồ sơ đã được xác nhận đầy đủ, hợp lệ từ ngày nào. Nếu doanh nghiệp chậm so với thời hạn áp dụng thì phải trả lãi cho số tiền chậm trả, theo khoản 2 Điều 31."],
   ["Bao lâu sau sự kiện thì không nộp hồ sơ được nữa?",
    "Thời hạn nộp hồ sơ là 01 năm kể từ ngày xảy ra sự kiện bảo hiểm. Thời gian bất khả kháng hoặc trở ngại khách quan không tính vào một năm này."],
   ["Người thân mất lâu rồi mới biết có hợp đồng bảo hiểm thì còn đòi được không?",
    "Khoản 2 Điều 30 cho đếm mốc một năm từ ngày người thụ hưởng biết việc xảy ra sự kiện, nếu chứng minh được trước đó không biết."],
 ],
 "lien_quan": ["ly-do-ho-so-bi-tu-choi-boi-thuong", "khi-nao-khong-duoc-tra-tien-bao-hiem", "bao-lanh-vien-phi-hoat-dong-the-nao"],
},
